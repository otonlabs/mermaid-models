# Investments - API Gateway BFF Container View [AWS / .NET 8 / ASP.NET Core]
...
## Diagrama
[Investments - API Gateway BFF Container View (AWS / .NET 8 / ASP.NET Core)](./investments-api-gw-bff-dotnet-container.mmd)
