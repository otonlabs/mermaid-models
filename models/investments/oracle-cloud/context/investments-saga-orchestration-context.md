# Investments com Saga Orchestration [Oracle Cloud]
...
- **Investments Platform** — sistema principal (Coordena transacoes distribuidas via orquestrador central no contexto de investi)
...
## Diagrama
[Investments com Saga Orchestration (Oracle Cloud)](./investments-saga-orchestration-context.mmd)
