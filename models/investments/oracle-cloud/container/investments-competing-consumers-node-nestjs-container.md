# Investments - Competing Consumers Container View [Oracle Cloud / Node.js / NestJS]
...
## Descrição
Multiplos consumidores competem para processar mensagens de fila compartilhada na camada de containers de investimentos e patrimonio

## Componentes Principais
- **Investments Service** — serviço principal rodando em OKE
...
## Diagrama
[Investments - Competing Consumers Container View (Oracle Cloud / Node.js / NestJS)](./investments-competing-consumers-node-nestjs-container.mmd)
