# Investments - Sidecar Pattern Container View [Oracle Cloud / Python / FastAPI]
...
## Descrição
Deploy de componentes auxiliares ao lado do servico principal nos containers de investimentos e patrimonio
...
## Diagrama
[Investments - Sidecar Pattern Container View (Oracle Cloud / Python / FastAPI)](./investments-sidecar-python-fastapi-container.mmd)
