# Investments - Message Translator Container View [Oracle Cloud / Java 21 / Spring Boot 3]
...
## Descrição
Traduz mensagens entre formatos diferentes via modelo canonico na camada de containers de investimentos e patrimonio
...
## Diagrama
[Investments - Message Translator Container View (Oracle Cloud / Java 21 / Spring Boot 3)](./investments-message-translator-java-spring-container.mmd)
