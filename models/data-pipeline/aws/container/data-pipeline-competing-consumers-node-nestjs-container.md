# Data Pipeline - Competing Consumers Container View [AWS / Node.js / NestJS]
...
- **Data Pipeline Service** — serviço principal rodando em ECS Fargate
...
## Diagrama
[Data Pipeline - Competing Consumers Container View (AWS / Node.js / NestJS)](./data-pipeline-competing-consumers-node-nestjs-container.mmd)
