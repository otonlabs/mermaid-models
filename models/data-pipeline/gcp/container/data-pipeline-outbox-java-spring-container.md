# Data Pipeline - Outbox Pattern Container View [GCP / Java 21 / Spring Boot 3]
...
## Diagrama
[Data Pipeline - Outbox Pattern Container View (GCP / Java 21 / Spring Boot 3)](./data-pipeline-outbox-java-spring-container.mmd)
