# Data Pipeline - Request-Reply Container View [Azure / Python / FastAPI]
...
## Descrição
Envia requisicao e aguarda resposta correlacionada na camada de containers de pipeline de dados e data lake
...
## Diagrama
[Data Pipeline - Request-Reply Container View (Azure / Python / FastAPI)](./data-pipeline-request-reply-python-fastapi-container.mmd)
