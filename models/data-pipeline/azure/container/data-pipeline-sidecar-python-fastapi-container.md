# Data Pipeline - Sidecar Pattern Container View [Azure / Python / FastAPI]
...
## Descrição
Deploy de componentes auxiliares ao lado do servico principal nos containers de pipeline de dados e data lake
...
## Diagrama
[Data Pipeline - Sidecar Pattern Container View (Azure / Python / FastAPI)](./data-pipeline-sidecar-python-fastapi-container.mmd)
