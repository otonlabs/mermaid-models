# Data Pipeline - API Gateway BFF Container View [Azure / .NET 8 / ASP.NET Core]
...
## Descrição
Backend-for-Frontend com API Gateway por canal nos containers de pipeline de dados e data lake
...
## Diagrama
[Data Pipeline - API Gateway BFF Container View (Azure / .NET 8 / ASP.NET Core)](./data-pipeline-api-gw-bff-dotnet-container.mmd)
