# Data Pipeline - Pipes and Filters Container View [Azure / Go / gRPC]
...
## Descrição
Processa mensagens atraves de pipeline de filtros sequenciais na camada de containers de pipeline de dados e data lake
...
## Diagrama
[Data Pipeline - Pipes and Filters Container View (Azure / Go / gRPC)](./data-pipeline-pipes-filters-go-grpc-container.mmd)
