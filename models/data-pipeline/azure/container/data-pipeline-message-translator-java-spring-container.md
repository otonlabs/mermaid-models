# Data Pipeline - Message Translator Container View [Azure / Java 21 / Spring Boot 3]
...
## Descrição
Traduz mensagens entre formatos diferentes via modelo canonico na camada de containers de pipeline de dados e data lake
...
## Diagrama
[Data Pipeline - Message Translator Container View (Azure / Java 21 / Spring Boot 3)](./data-pipeline-message-translator-java-spring-container.mmd)
