# Data Pipeline - Competing Consumers Container View [Azure / Node.js / NestJS]
...
## Descrição
Multiplos consumidores competem para processar mensagens de fila compartilhada na camada de containers de pipeline de dados e data lake
...
## Diagrama
[Data Pipeline - Competing Consumers Container View (Azure / Node.js / NestJS)](./data-pipeline-competing-consumers-node-nestjs-container.mmd)
