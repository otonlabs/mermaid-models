# DevOps CICD - Message Translator Container View [Azure / Java 21 / Spring Boot 3]
...
## Diagrama
[DevOps CICD - Message Translator Container View (Azure / Java 21 / Spring Boot 3)](./devops-cicd-message-translator-java-spring-container.mmd)
