# DevOps CICD - Scatter-Gather Container View [Azure / .NET 8 / ASP.NET Core]
...
## Diagrama
[DevOps CICD - Scatter-Gather Container View (Azure / .NET 8 / ASP.NET Core)](./devops-cicd-scatter-gather-dotnet-container.mmd)
