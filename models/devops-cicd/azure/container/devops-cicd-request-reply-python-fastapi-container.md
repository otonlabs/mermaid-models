# DevOps CICD - Request-Reply Container View [Azure / Python / FastAPI]
...
## Diagrama
[DevOps CICD - Request-Reply Container View (Azure / Python / FastAPI)](./devops-cicd-request-reply-python-fastapi-container.mmd)
