# DevOps CICD - Pub Sub - Component View [Azure / .NET 8 / ASP.NET Core]
...
## Diagrama
[DevOps CICD - Pub Sub - Component View (Azure / .NET 8 / ASP.NET Core)](./devops-cicd-pub-sub-dotnet-component.mmd)
