# DevOps CICD com Content-Based Router [Azure]
...
- **DevOps CICD Platform** — sistema principal (Roteia mensagens para canais diferentes baseado no conteudo aplicado ao contexto)
...
## Diagrama
[DevOps CICD com Content-Based Router (Azure)](./devops-cicd-content-based-router-context.mmd)
