# DevOps CICD - Request-Reply Container View [GCP / Python / FastAPI]
...
## Diagrama
[DevOps CICD - Request-Reply Container View (GCP / Python / FastAPI)](./devops-cicd-request-reply-python-fastapi-container.mmd)
