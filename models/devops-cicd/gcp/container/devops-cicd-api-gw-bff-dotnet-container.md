# DevOps CICD - API Gateway BFF Container View [GCP / .NET 8 / ASP.NET Core]
...
## Diagrama
[DevOps CICD - API Gateway BFF Container View (GCP / .NET 8 / ASP.NET Core)](./devops-cicd-api-gw-bff-dotnet-container.mmd)
