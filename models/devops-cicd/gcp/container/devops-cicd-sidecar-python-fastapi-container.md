# DevOps CICD - Sidecar Pattern Container View [GCP / Python / FastAPI]
...
## Diagrama
[DevOps CICD - Sidecar Pattern Container View (GCP / Python / FastAPI)](./devops-cicd-sidecar-python-fastapi-container.mmd)
