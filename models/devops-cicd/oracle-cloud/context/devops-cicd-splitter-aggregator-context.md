# DevOps CICD com Splitter-Aggregator [Oracle Cloud]
...
- **DevOps CICD Platform** — sistema principal (Divide mensagens compostas e agrega respostas aplicado ao contexto de devops e p)
...
## Diagrama
[DevOps CICD com Splitter-Aggregator (Oracle Cloud)](./devops-cicd-splitter-aggregator-context.mmd)
