# DevOps CICD - Bulkhead Pattern Container View [Oracle Cloud / Go / gRPC]
...
## Descrição
Isola recursos criticos para prevenir falhas em cascata nos containers de devops e pipelines ci/cd
...
## Diagrama
[DevOps CICD - Bulkhead Pattern Container View (Oracle Cloud / Go / gRPC)](./devops-cicd-bulkhead-go-grpc-container.mmd)
