# DevOps CICD - Request-Reply Container View [Oracle Cloud / Python / FastAPI]
...
## Descrição
Envia requisicao e aguarda resposta correlacionada na camada de containers de devops e pipelines ci/cd
...
## Diagrama
[DevOps CICD - Request-Reply Container View (Oracle Cloud / Python / FastAPI)](./devops-cicd-request-reply-python-fastapi-container.mmd)
