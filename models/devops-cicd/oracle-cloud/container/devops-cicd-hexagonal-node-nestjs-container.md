# DevOps CICD - Hexagonal Architecture Container View [Oracle Cloud / Node.js / NestJS]
...
## Descrição
Ports and Adapters para isolamento de dominio nos containers de devops e pipelines ci/cd
...
## Diagrama
[DevOps CICD - Hexagonal Architecture Container View (Oracle Cloud / Node.js / NestJS)](./devops-cicd-hexagonal-node-nestjs-container.mmd)
