# DevOps CICD - Competing Consumers Container View [Oracle Cloud / Node.js / NestJS]
...
## Descrição
Multiplos consumidores competem para processar mensagens de fila compartilhada na camada de containers de devops e pipelines ci/cd
...
## Diagrama
[DevOps CICD - Competing Consumers Container View (Oracle Cloud / Node.js / NestJS)](./devops-cicd-competing-consumers-node-nestjs-container.mmd)
