# DevOps CICD - Outbox Pattern Container View [Oracle Cloud / Java 21 / Spring Boot 3]
...
## Diagrama
[DevOps CICD - Outbox Pattern Container View (Oracle Cloud / Java 21 / Spring Boot 3)](./devops-cicd-outbox-java-spring-container.mmd)
