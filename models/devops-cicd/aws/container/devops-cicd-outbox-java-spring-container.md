# DevOps CICD - Outbox Pattern Container View [AWS / Java 21 / Spring Boot 3]
...
## Diagrama
[DevOps CICD - Outbox Pattern Container View (AWS / Java 21 / Spring Boot 3)](./devops-cicd-outbox-java-spring-container.mmd)
