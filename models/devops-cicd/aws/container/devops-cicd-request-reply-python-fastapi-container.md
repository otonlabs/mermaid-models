# DevOps CICD - Request-Reply Container View [AWS / Python / FastAPI]
...
## Diagrama
[DevOps CICD - Request-Reply Container View (AWS / Python / FastAPI)](./devops-cicd-request-reply-python-fastapi-container.mmd)
