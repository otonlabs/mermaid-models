# DevOps CICD - Sidecar Pattern Container View [AWS / Python / FastAPI]
...
## Diagrama
[DevOps CICD - Sidecar Pattern Container View (AWS / Python / FastAPI)](./devops-cicd-sidecar-python-fastapi-container.mmd)
