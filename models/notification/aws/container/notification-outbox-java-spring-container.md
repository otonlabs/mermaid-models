# Notification - Outbox Pattern Container View [AWS / Java 21 / Spring Boot 3]
...
## Diagrama
[Notification - Outbox Pattern Container View (AWS / Java 21 / Spring Boot 3)](./notification-outbox-java-spring-container.mmd)
