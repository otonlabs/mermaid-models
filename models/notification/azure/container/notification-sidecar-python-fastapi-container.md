# Notification - Sidecar Pattern Container View [Azure / Python / FastAPI]
...
## Diagrama
[Notification - Sidecar Pattern Container View (Azure / Python / FastAPI)](./notification-sidecar-python-fastapi-container.mmd)
