# Notification - Hexagonal Architecture Container View [Azure / Node.js / NestJS]
...
## Descrição
Ports and Adapters para isolamento de dominio nos containers de servicos de notificacao
...
## Diagrama
[Notification - Hexagonal Architecture Container View (Azure / Node.js / NestJS)](./notification-hexagonal-node-nestjs-container.mmd)
