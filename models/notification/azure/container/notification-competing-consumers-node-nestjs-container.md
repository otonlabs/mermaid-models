# Notification - Competing Consumers Container View [Azure / Node.js / NestJS]
...
## Descrição
Multiplos consumidores competem para processar mensagens de fila compartilhada na camada de containers de servicos de notificacao
...
## Diagrama
[Notification - Competing Consumers Container View (Azure / Node.js / NestJS)](./notification-competing-consumers-node-nestjs-container.mmd)
