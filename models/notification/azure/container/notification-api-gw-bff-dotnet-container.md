# Notification - API Gateway BFF Container View [Azure / .NET 8 / ASP.NET Core]
...
## Descrição
Backend-for-Frontend com API Gateway por canal nos containers de servicos de notificacao
...
## Diagrama
[Notification - API Gateway BFF Container View (Azure / .NET 8 / ASP.NET Core)](./notification-api-gw-bff-dotnet-container.mmd)
