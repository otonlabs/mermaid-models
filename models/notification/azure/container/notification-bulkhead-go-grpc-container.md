# Notification - Bulkhead Pattern Container View [Azure / Go / gRPC]
...
## Descrição
Isola recursos criticos para prevenir falhas em cascata nos containers de servicos de notificacao
...
## Diagrama
[Notification - Bulkhead Pattern Container View (Azure / Go / gRPC)](./notification-bulkhead-go-grpc-container.mmd)
