# Notification - API Gateway BFF Container View [GCP / .NET 8 / ASP.NET Core]
...
## Diagrama
[Notification - API Gateway BFF Container View (GCP / .NET 8 / ASP.NET Core)](./notification-api-gw-bff-dotnet-container.mmd)
