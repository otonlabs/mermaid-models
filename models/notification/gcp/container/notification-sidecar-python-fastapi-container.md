# Notification - Sidecar Pattern Container View [GCP / Python / FastAPI]
...
## Diagrama
[Notification - Sidecar Pattern Container View (GCP / Python / FastAPI)](./notification-sidecar-python-fastapi-container.mmd)
