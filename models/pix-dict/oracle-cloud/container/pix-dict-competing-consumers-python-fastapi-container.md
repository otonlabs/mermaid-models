# Processamento Massivo via Competing Consumers [Oracle Cloud / Python / FastAPI]
...
## Diagrama
[Processamento Massivo via Competing Consumers (Oracle Cloud / Python / FastAPI)](./pix-dict-competing-consumers-python-fastapi-container.mmd)
