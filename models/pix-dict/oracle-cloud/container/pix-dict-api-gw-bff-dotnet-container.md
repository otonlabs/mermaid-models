# API Gateway BFF para Canais PIX DICT [Oracle Cloud / .NET 8 / ASP.NET Core]
...
## Diagrama
[API Gateway BFF para Canais PIX DICT (Oracle Cloud / .NET 8 / ASP.NET Core)](./pix-dict-api-gw-bff-dotnet-container.mmd)
