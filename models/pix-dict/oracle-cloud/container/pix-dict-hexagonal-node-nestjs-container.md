# Hexagonal Architecture para Domain DICT [Oracle Cloud / Node.js / NestJS]
...
## Diagrama
[Hexagonal Architecture para Domain DICT (Oracle Cloud / Node.js / NestJS)](./pix-dict-hexagonal-node-nestjs-container.mmd)
