# Transformacao de Mensagens DICT com Message Translator [GCP / Node.js / NestJS]
...
## Diagrama
[Transformacao de Mensagens DICT com Message Translator (GCP / Node.js / NestJS)](./pix-dict-message-translator-node-nestjs-container.mmd)
