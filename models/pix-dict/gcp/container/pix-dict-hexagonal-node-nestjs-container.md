# Hexagonal Architecture para Domain DICT [GCP / Node.js / NestJS]
...
## Diagrama
[Hexagonal Architecture para Domain DICT (GCP / Node.js / NestJS)](./pix-dict-hexagonal-node-nestjs-container.mmd)
