# Transformacao de Mensagens DICT com Message Translator [Azure / Node.js / NestJS]
...
## Diagrama
[Transformacao de Mensagens DICT com Message Translator (Azure / Node.js / NestJS)](./pix-dict-message-translator-node-nestjs-container.mmd)
