# Sidecar para mTLS com BACEN DICT [Azure / Python / FastAPI]
...
## Diagrama
[Sidecar para mTLS com BACEN DICT (Azure / Python / FastAPI)](./pix-dict-sidecar-python-fastapi-container.mmd)
