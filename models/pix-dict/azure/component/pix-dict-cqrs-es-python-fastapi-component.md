# PIX DICT - Cqrs Es - Component View [Azure / Python / FastAPI]
...
## Diagrama
[PIX DICT - Cqrs Es - Component View (Azure / Python / FastAPI)](./pix-dict-cqrs-es-python-fastapi-component.mmd)
