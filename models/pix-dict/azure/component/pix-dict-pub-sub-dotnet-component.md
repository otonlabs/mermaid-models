# PIX DICT - Pub Sub - Component View [Azure / .NET 8 / ASP.NET Core]
...
## Diagrama
[PIX DICT - Pub Sub - Component View (Azure / .NET 8 / ASP.NET Core)](./pix-dict-pub-sub-dotnet-component.mmd)
