# Pipeline de Validacao de Chaves com Pipes and Filters [AWS / Java 21 / Spring Boot 3]
...
## Diagrama
[Pipeline de Validacao de Chaves com Pipes and Filters (AWS / Java 21 / Spring Boot 3)](./pix-dict-pipes-filters-java-spring-container.mmd)
