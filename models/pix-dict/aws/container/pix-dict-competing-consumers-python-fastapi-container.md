# Processamento Massivo via Competing Consumers [AWS / Python / FastAPI]
...
## Diagrama
[Processamento Massivo via Competing Consumers (AWS / Python / FastAPI)](./pix-dict-competing-consumers-python-fastapi-container.mmd)
