# API Gateway BFF para Canais PIX DICT [AWS / .NET 8 / ASP.NET Core]
...
## Diagrama
[API Gateway BFF para Canais PIX DICT (AWS / .NET 8 / ASP.NET Core)](./pix-dict-api-gw-bff-dotnet-container.mmd)
