# Registro Sincrono via Request-Reply [AWS / .NET 8 / ASP.NET Core]
...
## Diagrama
[Registro Sincrono via Request-Reply (AWS / .NET 8 / ASP.NET Core)](./pix-dict-request-reply-dotnet-container.mmd)
