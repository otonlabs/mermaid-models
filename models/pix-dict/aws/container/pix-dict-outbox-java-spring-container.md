# Outbox Pattern para Consistencia DICT [AWS / Java 21 / Spring Boot 3]
...
## Diagrama
[Outbox Pattern para Consistencia DICT (AWS / Java 21 / Spring Boot 3)](./pix-dict-outbox-java-spring-container.mmd)
