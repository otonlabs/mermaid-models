# Credit Lending - Scatter-Gather Container View [Azure / .NET 8 / ASP.NET Core]
...
## Descrição
Distribui requisicao para multiplos destinatarios e agrega respostas na camada de containers de credito e emprestimos
...
## Diagrama
[Credit Lending - Scatter-Gather Container View (Azure / .NET 8 / ASP.NET Core)](./credit-lending-scatter-gather-dotnet-container.mmd)
