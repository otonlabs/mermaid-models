# Credit Lending - API Gateway BFF Container View [GCP / .NET 8 / ASP.NET Core]
...
## Diagrama
[Credit Lending - API Gateway BFF Container View (GCP / .NET 8 / ASP.NET Core)](./credit-lending-api-gw-bff-dotnet-container.mmd)
