# Credit Lending - Outbox Pattern Container View [Oracle Cloud / Java 21 / Spring Boot 3]
...
## Descrição
Garante publicacao confiavel de mensagens via transactional outbox nos containers de credito e emprestimos
...
## Diagrama
[Credit Lending - Outbox Pattern Container View (Oracle Cloud / Java 21 / Spring Boot 3)](./credit-lending-outbox-java-spring-container.mmd)
