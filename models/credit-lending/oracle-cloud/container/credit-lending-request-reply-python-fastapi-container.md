# Credit Lending - Request-Reply Container View [Oracle Cloud / Python / FastAPI]
...
## Descrição
Envia requisicao e aguarda resposta correlacionada na camada de containers de credito e emprestimos
...
## Diagrama
[Credit Lending - Request-Reply Container View (Oracle Cloud / Python / FastAPI)](./credit-lending-request-reply-python-fastapi-container.mmd)
