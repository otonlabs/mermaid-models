# Credit Lending - Message Translator Container View [Oracle Cloud / Java 21 / Spring Boot 3]
...
## Descrição
Traduz mensagens entre formatos diferentes via modelo canonico na camada de containers de credito e emprestimos
...
## Diagrama
[Credit Lending - Message Translator Container View (Oracle Cloud / Java 21 / Spring Boot 3)](./credit-lending-message-translator-java-spring-container.mmd)
