# Treasury - API Gateway BFF Container View [GCP / .NET 8 / ASP.NET Core]
...
## Diagrama
[Treasury - API Gateway BFF Container View (GCP / .NET 8 / ASP.NET Core)](./treasury-api-gw-bff-dotnet-container.mmd)
