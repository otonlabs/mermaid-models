# Treasury - API Gateway BFF Container View [Azure / .NET 8 / ASP.NET Core]
...
## Diagrama
[Treasury - API Gateway BFF Container View (Azure / .NET 8 / ASP.NET Core)](./treasury-api-gw-bff-dotnet-container.mmd)
