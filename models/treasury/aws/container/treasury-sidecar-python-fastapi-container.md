# Treasury - Sidecar Pattern Container View [AWS / Python / FastAPI]
...
## Descrição
Deploy de componentes auxiliares ao lado do servico principal nos containers de gestao de tesouraria
...
## Diagrama
[Treasury - Sidecar Pattern Container View (AWS / Python / FastAPI)](./treasury-sidecar-python-fastapi-container.mmd)
