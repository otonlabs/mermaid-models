# Treasury - Outbox Pattern Container View [AWS / Java 21 / Spring Boot 3]
...
## Diagrama
[Treasury - Outbox Pattern Container View (AWS / Java 21 / Spring Boot 3)](./treasury-outbox-java-spring-container.mmd)
