# Treasury - Request-Reply Container View [AWS / Python / FastAPI]
...
## Descrição
Envia requisicao e aguarda resposta correlacionada na camada de containers de gestao de tesouraria
...
## Diagrama
[Treasury - Request-Reply Container View (AWS / Python / FastAPI)](./treasury-request-reply-python-fastapi-container.mmd)
