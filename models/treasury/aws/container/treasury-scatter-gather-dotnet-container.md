# Treasury - Scatter-Gather Container View [AWS / .NET 8 / ASP.NET Core]
...
## Descrição
Distribui requisicao para multiplos destinatarios e agrega respostas na camada de containers de gestao de tesouraria
...
## Diagrama
[Treasury - Scatter-Gather Container View (AWS / .NET 8 / ASP.NET Core)](./treasury-scatter-gather-dotnet-container.mmd)
