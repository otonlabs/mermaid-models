# Treasury - Message Translator Container View [AWS / Java 21 / Spring Boot 3]
...
## Descrição
Traduz mensagens entre formatos diferentes via modelo canonico na camada de containers de gestao de tesouraria
...
## Diagrama
[Treasury - Message Translator Container View (AWS / Java 21 / Spring Boot 3)](./treasury-message-translator-java-spring-container.mmd)
