# Treasury - Competing Consumers Container View [AWS / Node.js / NestJS]
...
## Descrição
Multiplos consumidores competem para processar mensagens de fila compartilhada na camada de containers de gestao de tesouraria

## Componentes Principais
- **Treasury Service** — serviço principal rodando em ECS Fargate
...
## Diagrama
[Treasury - Competing Consumers Container View (AWS / Node.js / NestJS)](./treasury-competing-consumers-node-nestjs-container.mmd)
