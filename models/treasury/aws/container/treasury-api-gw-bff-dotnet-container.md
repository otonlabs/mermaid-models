# Treasury - API Gateway BFF Container View [AWS / .NET 8 / ASP.NET Core]
...
## Descrição
Backend-for-Frontend com API Gateway por canal nos containers de gestao de tesouraria
...
## Diagrama
[Treasury - API Gateway BFF Container View (AWS / .NET 8 / ASP.NET Core)](./treasury-api-gw-bff-dotnet-container.mmd)
