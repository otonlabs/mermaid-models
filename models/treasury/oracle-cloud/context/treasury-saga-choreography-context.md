# Treasury com Saga Choreography [Oracle Cloud]
...
- **Treasury Platform** — sistema principal (Coordena transacoes distribuidas via coreografia de eventos no contexto de gesta)
...
## Diagrama
[Treasury com Saga Choreography (Oracle Cloud)](./treasury-saga-choreography-context.mmd)
