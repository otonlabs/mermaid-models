# Treasury com Content-Based Router [Oracle Cloud]
...
- **Treasury Platform** — sistema principal (Roteia mensagens para canais diferentes baseado no conteudo aplicado ao contexto)
...
## Diagrama
[Treasury com Content-Based Router (Oracle Cloud)](./treasury-content-based-router-context.mmd)
