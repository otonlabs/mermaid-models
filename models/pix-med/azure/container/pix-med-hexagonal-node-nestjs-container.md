# Domain MED com Hexagonal Architecture [Azure / Node.js / NestJS]
...
## Diagrama
[Domain MED com Hexagonal Architecture (Azure / Node.js / NestJS)](./pix-med-hexagonal-node-nestjs-container.mmd)
