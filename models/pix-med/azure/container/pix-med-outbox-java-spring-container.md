# Outbox para Garantia de Notificacao MED [Azure / Java 21 / Spring Boot 3]
...
## Diagrama
[Outbox para Garantia de Notificacao MED (Azure / Java 21 / Spring Boot 3)](./pix-med-outbox-java-spring-container.mmd)
