# BFF para Canais MED (Vitima, Analista, Compliance) [Azure / .NET 8 / ASP.NET Core]
...
## Diagrama
[BFF para Canais MED (Vitima, Analista, Compliance) (Azure / .NET 8 / ASP.NET Core)](./pix-med-api-gw-bff-dotnet-container.mmd)
