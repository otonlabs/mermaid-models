# Consulta Multi-Fonte para Decisao MED [Azure / Go / gRPC]
...
## Descrição
Scatter para anti-fraude, bureau de credito e historico transacional em paralelo
...
## Diagrama
[Consulta Multi-Fonte para Decisao MED (Azure / Go / gRPC)](./pix-med-scatter-gather-go-grpc-container.mmd)
