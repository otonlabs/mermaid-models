# Traducao de Formato MED via Message Translator [AWS / Node.js / NestJS]
...
## Diagrama
[Traducao de Formato MED via Message Translator (AWS / Node.js / NestJS)](./pix-med-message-translator-node-nestjs-container.mmd)
