# Notificacao Sincrona MED via Request-Reply [GCP / .NET 8 / ASP.NET Core]
...
## Diagrama
[Notificacao Sincrona MED via Request-Reply (GCP / .NET 8 / ASP.NET Core)](./pix-med-request-reply-dotnet-container.mmd)
