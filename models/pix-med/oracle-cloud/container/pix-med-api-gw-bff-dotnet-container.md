# BFF para Canais MED (Vitima, Analista, Compliance) [Oracle Cloud / .NET 8 / ASP.NET Core]
...
## Diagrama
[BFF para Canais MED (Vitima, Analista, Compliance) (Oracle Cloud / .NET 8 / ASP.NET Core)](./pix-med-api-gw-bff-dotnet-container.mmd)
