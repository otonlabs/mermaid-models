# Sidecar para Comunicacao MED Segura [Oracle Cloud / Python / FastAPI]
...
## Diagrama
[Sidecar para Comunicacao MED Segura (Oracle Cloud / Python / FastAPI)](./pix-med-sidecar-python-fastapi-container.mmd)
