# Traducao de Formato MED via Message Translator [Oracle Cloud / Node.js / NestJS]
...
## Descrição
Conversao de formato interno de caso para XML MED do BACEN
...
## Diagrama
[Traducao de Formato MED via Message Translator (Oracle Cloud / Node.js / NestJS)](./pix-med-message-translator-node-nestjs-container.mmd)
