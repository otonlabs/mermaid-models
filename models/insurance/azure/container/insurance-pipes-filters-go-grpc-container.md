# Insurance - Pipes and Filters Container View [Azure / Go / gRPC]
...
## Descrição
Processa mensagens atraves de pipeline de filtros sequenciais na camada de containers de plataforma de seguros
...
## Diagrama
[Insurance - Pipes and Filters Container View (Azure / Go / gRPC)](./insurance-pipes-filters-go-grpc-container.mmd)
