# Insurance - Message Translator Container View [Azure / Java 21 / Spring Boot 3]
...
## Descrição
Traduz mensagens entre formatos diferentes via modelo canonico na camada de containers de plataforma de seguros
...
## Diagrama
[Insurance - Message Translator Container View (Azure / Java 21 / Spring Boot 3)](./insurance-message-translator-java-spring-container.mmd)
