# Insurance - Bulkhead Pattern Container View [Azure / Go / gRPC]
...
## Descrição
Isola recursos criticos para prevenir falhas em cascata nos containers de plataforma de seguros
...
## Diagrama
[Insurance - Bulkhead Pattern Container View (Azure / Go / gRPC)](./insurance-bulkhead-go-grpc-container.mmd)
