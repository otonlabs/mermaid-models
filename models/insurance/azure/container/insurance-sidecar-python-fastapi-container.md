# Insurance - Sidecar Pattern Container View [Azure / Python / FastAPI]
...
## Descrição
Deploy de componentes auxiliares ao lado do servico principal nos containers de plataforma de seguros
...
## Diagrama
[Insurance - Sidecar Pattern Container View (Azure / Python / FastAPI)](./insurance-sidecar-python-fastapi-container.mmd)
