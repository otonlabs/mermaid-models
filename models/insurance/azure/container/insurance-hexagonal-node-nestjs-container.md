# Insurance - Hexagonal Architecture Container View [Azure / Node.js / NestJS]
...
## Descrição
Ports and Adapters para isolamento de dominio nos containers de plataforma de seguros
...
## Diagrama
[Insurance - Hexagonal Architecture Container View (Azure / Node.js / NestJS)](./insurance-hexagonal-node-nestjs-container.mmd)
