# Insurance - API Gateway BFF Container View [Azure / .NET 8 / ASP.NET Core]
...
## Descrição
Backend-for-Frontend com API Gateway por canal nos containers de plataforma de seguros
...
## Diagrama
[Insurance - API Gateway BFF Container View (Azure / .NET 8 / ASP.NET Core)](./insurance-api-gw-bff-dotnet-container.mmd)
