# Insurance com Wire Tap [Oracle Cloud]
...
- **Insurance Platform** — sistema principal (Intercepta e registra mensagens em transito para auditoria aplicado ao contexto )
...
## Diagrama
[Insurance com Wire Tap (Oracle Cloud)](./insurance-wire-tap-context.mmd)
