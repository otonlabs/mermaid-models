# Insurance com CQRS + Event Sourcing [Oracle Cloud]
...
- **Insurance Platform** — sistema principal (Separa modelos de leitura e escrita com estado baseado em eventos no contexto de)
...
## Diagrama
[Insurance com CQRS + Event Sourcing (Oracle Cloud)](./insurance-cqrs-es-context.mmd)
