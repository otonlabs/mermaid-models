# Insurance - API Gateway BFF Container View [Oracle Cloud / .NET 8 / ASP.NET Core]
...
## Diagrama
[Insurance - API Gateway BFF Container View (Oracle Cloud / .NET 8 / ASP.NET Core)](./insurance-api-gw-bff-dotnet-container.mmd)
