# Insurance - Request-Reply Container View [AWS / Python / FastAPI]
...
## Diagrama
[Insurance - Request-Reply Container View (AWS / Python / FastAPI)](./insurance-request-reply-python-fastapi-container.mmd)
