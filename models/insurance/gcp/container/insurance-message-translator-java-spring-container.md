# Insurance - Message Translator Container View [GCP / Java 21 / Spring Boot 3]
...
- **Insurance Service** — serviço principal rodando em Cloud Run
...
## Diagrama
[Insurance - Message Translator Container View (GCP / Java 21 / Spring Boot 3)](./insurance-message-translator-java-spring-container.mmd)
