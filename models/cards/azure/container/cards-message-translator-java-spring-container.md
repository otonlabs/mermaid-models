# Cards - Message Translator Container View [Azure / Java 21 / Spring Boot 3]
...
## Diagrama
[Cards - Message Translator Container View (Azure / Java 21 / Spring Boot 3)](./cards-message-translator-java-spring-container.mmd)
