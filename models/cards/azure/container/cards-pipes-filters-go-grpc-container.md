# Cards - Pipes and Filters Container View [Azure / Go / gRPC]
...
## Descrição
Processa mensagens atraves de pipeline de filtros sequenciais na camada de containers de processamento de cartoes
...
## Diagrama
[Cards - Pipes and Filters Container View (Azure / Go / gRPC)](./cards-pipes-filters-go-grpc-container.mmd)
