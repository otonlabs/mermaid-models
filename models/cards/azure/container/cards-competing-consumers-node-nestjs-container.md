# Cards - Competing Consumers Container View [Azure / Node.js / NestJS]
...
## Descrição
Multiplos consumidores competem para processar mensagens de fila compartilhada na camada de containers de processamento de cartoes
...
## Diagrama
[Cards - Competing Consumers Container View (Azure / Node.js / NestJS)](./cards-competing-consumers-node-nestjs-container.mmd)
