# Cards - Hexagonal Architecture Container View [Azure / Node.js / NestJS]
...
## Descrição
Ports and Adapters para isolamento de dominio nos containers de processamento de cartoes
...
## Diagrama
[Cards - Hexagonal Architecture Container View (Azure / Node.js / NestJS)](./cards-hexagonal-node-nestjs-container.mmd)
