# Cards - Outbox Pattern Container View [Azure / Java 21 / Spring Boot 3]
...
## Diagrama
[Cards - Outbox Pattern Container View (Azure / Java 21 / Spring Boot 3)](./cards-outbox-java-spring-container.mmd)
