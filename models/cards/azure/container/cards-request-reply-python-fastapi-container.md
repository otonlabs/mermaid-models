# Cards - Request-Reply Container View [Azure / Python / FastAPI]
...
## Descrição
Envia requisicao e aguarda resposta correlacionada na camada de containers de processamento de cartoes
...
## Diagrama
[Cards - Request-Reply Container View (Azure / Python / FastAPI)](./cards-request-reply-python-fastapi-container.mmd)
