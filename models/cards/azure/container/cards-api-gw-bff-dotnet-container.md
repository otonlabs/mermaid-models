# Cards - API Gateway BFF Container View [Azure / .NET 8 / ASP.NET Core]
...
## Descrição
Backend-for-Frontend com API Gateway por canal nos containers de processamento de cartoes
...
## Diagrama
[Cards - API Gateway BFF Container View (Azure / .NET 8 / ASP.NET Core)](./cards-api-gw-bff-dotnet-container.mmd)
