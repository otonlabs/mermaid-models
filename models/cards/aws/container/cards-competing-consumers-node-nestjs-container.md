# Cards - Competing Consumers Container View [AWS / Node.js / NestJS]
...
- **Cards Service** — serviço principal rodando em ECS Fargate
...
## Diagrama
[Cards - Competing Consumers Container View (AWS / Node.js / NestJS)](./cards-competing-consumers-node-nestjs-container.mmd)
