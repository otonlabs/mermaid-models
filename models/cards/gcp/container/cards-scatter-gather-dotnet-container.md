# Cards - Scatter-Gather Container View [GCP / .NET 8 / ASP.NET Core]
...
## Diagrama
[Cards - Scatter-Gather Container View (GCP / .NET 8 / ASP.NET Core)](./cards-scatter-gather-dotnet-container.mmd)
