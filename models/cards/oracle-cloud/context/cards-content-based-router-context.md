# Cards com Content-Based Router [Oracle Cloud]
...
- **Cards Platform** — sistema principal (Roteia mensagens para canais diferentes baseado no conteudo aplicado ao contexto)
...
## Diagrama
[Cards com Content-Based Router (Oracle Cloud)](./cards-content-based-router-context.mmd)
