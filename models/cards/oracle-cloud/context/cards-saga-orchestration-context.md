# Cards com Saga Orchestration [Oracle Cloud]
...
- **Cards Platform** — sistema principal (Coordena transacoes distribuidas via orquestrador central no contexto de process)
...
## Diagrama
[Cards com Saga Orchestration (Oracle Cloud)](./cards-saga-orchestration-context.mmd)
