# Cards com Saga Choreography [Oracle Cloud]
...
- **Cards Platform** — sistema principal (Coordena transacoes distribuidas via coreografia de eventos no contexto de proce)
...
## Diagrama
[Cards com Saga Choreography (Oracle Cloud)](./cards-saga-choreography-context.mmd)
