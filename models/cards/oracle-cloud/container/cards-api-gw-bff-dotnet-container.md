# Cards - API Gateway BFF Container View [Oracle Cloud / .NET 8 / ASP.NET Core]
...
## Diagrama
[Cards - API Gateway BFF Container View (Oracle Cloud / .NET 8 / ASP.NET Core)](./cards-api-gw-bff-dotnet-container.mmd)
