# Payments - Scatter-Gather Container View [AWS / .NET 8 / ASP.NET Core]
...
## Diagrama
[Payments - Scatter-Gather Container View (AWS / .NET 8 / ASP.NET Core)](./payments-scatter-gather-dotnet-container.mmd)
