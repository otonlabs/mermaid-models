# Payments - API Gateway BFF Container View [AWS / .NET 8 / ASP.NET Core]
...
## Diagrama
[Payments - API Gateway BFF Container View (AWS / .NET 8 / ASP.NET Core)](./payments-api-gw-bff-dotnet-container.mmd)
