# Payments - Competing Consumers Container View [AWS / Node.js / NestJS]
...
- **Payments Service** — serviço principal rodando em ECS Fargate
...
## Diagrama
[Payments - Competing Consumers Container View (AWS / Node.js / NestJS)](./payments-competing-consumers-node-nestjs-container.mmd)
