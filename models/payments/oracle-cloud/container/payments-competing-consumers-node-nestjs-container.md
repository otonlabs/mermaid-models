# Payments - Competing Consumers Container View [Oracle Cloud / Node.js / NestJS]
...
## Descrição
Multiplos consumidores competem para processar mensagens de fila compartilhada na camada de containers de processamento de pagamentos

## Componentes Principais
- **Payments Service** — serviço principal rodando em OKE
...
## Diagrama
[Payments - Competing Consumers Container View (Oracle Cloud / Node.js / NestJS)](./payments-competing-consumers-node-nestjs-container.mmd)
