# Payments - Request-Reply Container View [Oracle Cloud / Python / FastAPI]
...
## Descrição
Envia requisicao e aguarda resposta correlacionada na camada de containers de processamento de pagamentos
...
## Diagrama
[Payments - Request-Reply Container View (Oracle Cloud / Python / FastAPI)](./payments-request-reply-python-fastapi-container.mmd)
