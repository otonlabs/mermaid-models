# Payments - Pipes and Filters Container View [Oracle Cloud / Go / gRPC]
...
## Descrição
Processa mensagens atraves de pipeline de filtros sequenciais na camada de containers de processamento de pagamentos
...
## Diagrama
[Payments - Pipes and Filters Container View (Oracle Cloud / Go / gRPC)](./payments-pipes-filters-go-grpc-container.mmd)
