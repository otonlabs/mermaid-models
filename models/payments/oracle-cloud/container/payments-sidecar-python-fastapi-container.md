# Payments - Sidecar Pattern Container View [Oracle Cloud / Python / FastAPI]
...
## Descrição
Deploy de componentes auxiliares ao lado do servico principal nos containers de processamento de pagamentos
...
## Diagrama
[Payments - Sidecar Pattern Container View (Oracle Cloud / Python / FastAPI)](./payments-sidecar-python-fastapi-container.mmd)
