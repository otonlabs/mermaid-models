# Payments - Scatter-Gather Container View [Azure / .NET 8 / ASP.NET Core]
...
## Descrição
Distribui requisicao para multiplos destinatarios e agrega respostas na camada de containers de processamento de pagamentos
...
## Diagrama
[Payments - Scatter-Gather Container View (Azure / .NET 8 / ASP.NET Core)](./payments-scatter-gather-dotnet-container.mmd)
