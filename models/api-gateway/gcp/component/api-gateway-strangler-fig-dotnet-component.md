# API Gateway - Strangler Fig - Component View [GCP / .NET 8 / ASP.NET Core]
...
## Diagrama
[API Gateway - Strangler Fig - Component View (GCP / .NET 8 / ASP.NET Core)](./api-gateway-strangler-fig-dotnet-component.mmd)
