# API Gateway - Pub Sub - Component View [GCP / .NET 8 / ASP.NET Core]
...
## Diagrama
[API Gateway - Pub Sub - Component View (GCP / .NET 8 / ASP.NET Core)](./api-gateway-pub-sub-dotnet-component.mmd)
