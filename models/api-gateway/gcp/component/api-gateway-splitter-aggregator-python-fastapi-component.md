# API Gateway - Splitter Aggregator - Component View [GCP / Python / FastAPI]
...
## Diagrama
[API Gateway - Splitter Aggregator - Component View (GCP / Python / FastAPI)](./api-gateway-splitter-aggregator-python-fastapi-component.mmd)
