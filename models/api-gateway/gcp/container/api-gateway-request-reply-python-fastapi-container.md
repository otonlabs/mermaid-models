# API Gateway - Request-Reply Container View [GCP / Python / FastAPI]
...
## Diagrama
[API Gateway - Request-Reply Container View (GCP / Python / FastAPI)](./api-gateway-request-reply-python-fastapi-container.mmd)
