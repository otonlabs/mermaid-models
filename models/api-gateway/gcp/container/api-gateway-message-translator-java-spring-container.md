# API Gateway - Message Translator Container View [GCP / Java 21 / Spring Boot 3]
...
## Diagrama
[API Gateway - Message Translator Container View (GCP / Java 21 / Spring Boot 3)](./api-gateway-message-translator-java-spring-container.mmd)
