# API Gateway - Hexagonal Architecture Container View [GCP / Node.js / NestJS]
...
## Diagrama
[API Gateway - Hexagonal Architecture Container View (GCP / Node.js / NestJS)](./api-gateway-hexagonal-node-nestjs-container.mmd)
