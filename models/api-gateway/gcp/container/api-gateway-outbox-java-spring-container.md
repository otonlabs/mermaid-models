# API Gateway - Outbox Pattern Container View [GCP / Java 21 / Spring Boot 3]
...
## Diagrama
[API Gateway - Outbox Pattern Container View (GCP / Java 21 / Spring Boot 3)](./api-gateway-outbox-java-spring-container.mmd)
