# API Gateway - Sidecar Pattern Container View [GCP / Python / FastAPI]
...
## Diagrama
[API Gateway - Sidecar Pattern Container View (GCP / Python / FastAPI)](./api-gateway-sidecar-python-fastapi-container.mmd)
