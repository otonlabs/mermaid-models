# API Gateway - Saga Orchestration - Component View [AWS / Node.js / NestJS]
...
## Diagrama
[API Gateway - Saga Orchestration - Component View (AWS / Node.js / NestJS)](./api-gateway-saga-orchestration-node-nestjs-component.mmd)
