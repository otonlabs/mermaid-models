# API Gateway - Splitter Aggregator - Component View [AWS / Python / FastAPI]
...
## Diagrama
[API Gateway - Splitter Aggregator - Component View (AWS / Python / FastAPI)](./api-gateway-splitter-aggregator-python-fastapi-component.mmd)
