# API Gateway - Cqrs Es - Component View [AWS / Python / FastAPI]
...
## Diagrama
[API Gateway - Cqrs Es - Component View (AWS / Python / FastAPI)](./api-gateway-cqrs-es-python-fastapi-component.mmd)
