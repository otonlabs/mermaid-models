# API Gateway - Strangler Fig - Component View [AWS / .NET 8 / ASP.NET Core]
...
## Diagrama
[API Gateway - Strangler Fig - Component View (AWS / .NET 8 / ASP.NET Core)](./api-gateway-strangler-fig-dotnet-component.mmd)
