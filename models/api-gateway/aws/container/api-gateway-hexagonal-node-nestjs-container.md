# API Gateway - Hexagonal Architecture Container View [AWS / Node.js / NestJS]
...
## Diagrama
[API Gateway - Hexagonal Architecture Container View (AWS / Node.js / NestJS)](./api-gateway-hexagonal-node-nestjs-container.mmd)
