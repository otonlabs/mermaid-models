# API Gateway - Competing Consumers Container View [AWS / Node.js / NestJS]
...
## Diagrama
[API Gateway - Competing Consumers Container View (AWS / Node.js / NestJS)](./api-gateway-competing-consumers-node-nestjs-container.mmd)
