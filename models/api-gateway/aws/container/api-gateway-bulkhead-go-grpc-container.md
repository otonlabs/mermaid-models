# API Gateway - Bulkhead Pattern Container View [AWS / Go / gRPC]
...
## Diagrama
[API Gateway - Bulkhead Pattern Container View (AWS / Go / gRPC)](./api-gateway-bulkhead-go-grpc-container.mmd)
