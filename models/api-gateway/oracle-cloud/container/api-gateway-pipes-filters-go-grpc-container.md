# API Gateway - Pipes and Filters Container View [Oracle Cloud / Go / gRPC]
...
## Diagrama
[API Gateway - Pipes and Filters Container View (Oracle Cloud / Go / gRPC)](./api-gateway-pipes-filters-go-grpc-container.mmd)
