# API Gateway - API Gateway BFF Container View [Oracle Cloud / .NET 8 / ASP.NET Core]
...
## Diagrama
[API Gateway - API Gateway BFF Container View (Oracle Cloud / .NET 8 / ASP.NET Core)](./api-gateway-api-gw-bff-dotnet-container.mmd)
