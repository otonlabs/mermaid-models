# API Gateway - Competing Consumers Container View [Oracle Cloud / Node.js / NestJS]
...
## Diagrama
[API Gateway - Competing Consumers Container View (Oracle Cloud / Node.js / NestJS)](./api-gateway-competing-consumers-node-nestjs-container.mmd)
