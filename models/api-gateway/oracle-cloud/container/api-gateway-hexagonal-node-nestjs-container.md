# API Gateway - Hexagonal Architecture Container View [Oracle Cloud / Node.js / NestJS]
...
## Diagrama
[API Gateway - Hexagonal Architecture Container View (Oracle Cloud / Node.js / NestJS)](./api-gateway-hexagonal-node-nestjs-container.mmd)
