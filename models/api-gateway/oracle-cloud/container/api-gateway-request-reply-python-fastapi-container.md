# API Gateway - Request-Reply Container View [Oracle Cloud / Python / FastAPI]
...
## Diagrama
[API Gateway - Request-Reply Container View (Oracle Cloud / Python / FastAPI)](./api-gateway-request-reply-python-fastapi-container.mmd)
