# API Gateway - Bulkhead Pattern Container View [Oracle Cloud / Go / gRPC]
...
## Diagrama
[API Gateway - Bulkhead Pattern Container View (Oracle Cloud / Go / gRPC)](./api-gateway-bulkhead-go-grpc-container.mmd)
