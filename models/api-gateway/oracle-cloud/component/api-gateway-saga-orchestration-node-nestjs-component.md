# API Gateway - Saga Orchestration - Component View [Oracle Cloud / Node.js / NestJS]
...
## Diagrama
[API Gateway - Saga Orchestration - Component View (Oracle Cloud / Node.js / NestJS)](./api-gateway-saga-orchestration-node-nestjs-component.mmd)
