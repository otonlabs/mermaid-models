# API Gateway - Strangler Fig - Component View [Oracle Cloud / .NET 8 / ASP.NET Core]
...
## Diagrama
[API Gateway - Strangler Fig - Component View (Oracle Cloud / .NET 8 / ASP.NET Core)](./api-gateway-strangler-fig-dotnet-component.mmd)
