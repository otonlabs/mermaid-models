# API Gateway - Content Based Router - Component View [Oracle Cloud / Go / gRPC]
...
## Diagrama
[API Gateway - Content Based Router - Component View (Oracle Cloud / Go / gRPC)](./api-gateway-content-based-router-go-grpc-component.mmd)
