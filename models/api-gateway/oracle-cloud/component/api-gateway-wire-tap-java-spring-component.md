# API Gateway - Wire Tap - Component View [Oracle Cloud / Java 21 / Spring Boot 3]
...
## Diagrama
[API Gateway - Wire Tap - Component View (Oracle Cloud / Java 21 / Spring Boot 3)](./api-gateway-wire-tap-java-spring-component.mmd)
