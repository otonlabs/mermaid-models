# API Gateway - Cqrs Es - Component View [Oracle Cloud / Python / FastAPI]
...
## Diagrama
[API Gateway - Cqrs Es - Component View (Oracle Cloud / Python / FastAPI)](./api-gateway-cqrs-es-python-fastapi-component.mmd)
