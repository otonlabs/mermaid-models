# API Gateway - Splitter Aggregator - Component View [Oracle Cloud / Python / FastAPI]
...
## Diagrama
[API Gateway - Splitter Aggregator - Component View (Oracle Cloud / Python / FastAPI)](./api-gateway-splitter-aggregator-python-fastapi-component.mmd)
