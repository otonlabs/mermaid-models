# API Gateway com CQRS + Event Sourcing [Oracle Cloud]
...
- **API Gateway Platform** — sistema principal (Separa modelos de leitura e escrita com estado baseado em eventos no contexto de)
...
## Diagrama
[API Gateway com CQRS + Event Sourcing (Oracle Cloud)](./api-gateway-cqrs-es-context.mmd)
