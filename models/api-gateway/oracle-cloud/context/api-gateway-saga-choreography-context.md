# API Gateway com Saga Choreography [Oracle Cloud]
...
- **API Gateway Platform** — sistema principal (Coordena transacoes distribuidas via coreografia de eventos no contexto de api g)
...
## Diagrama
[API Gateway com Saga Choreography (Oracle Cloud)](./api-gateway-saga-choreography-context.mmd)
