# API Gateway - API Gateway BFF Container View [Azure / .NET 8 / ASP.NET Core]
...
## Descrição
Backend-for-Frontend com API Gateway por canal nos containers de api gateway e hub de integracao
...
## Diagrama
[API Gateway - API Gateway BFF Container View (Azure / .NET 8 / ASP.NET Core)](./api-gateway-api-gw-bff-dotnet-container.mmd)
