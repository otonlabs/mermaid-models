# API Gateway - Scatter-Gather Container View [Azure / .NET 8 / ASP.NET Core]
...
## Diagrama
[API Gateway - Scatter-Gather Container View (Azure / .NET 8 / ASP.NET Core)](./api-gateway-scatter-gather-dotnet-container.mmd)
