# API Gateway - Request-Reply Container View [Azure / Python / FastAPI]
...
## Diagrama
[API Gateway - Request-Reply Container View (Azure / Python / FastAPI)](./api-gateway-request-reply-python-fastapi-container.mmd)
