# API Gateway - Pipes and Filters Container View [Azure / Go / gRPC]
...
## Descrição
Processa mensagens atraves de pipeline de filtros sequenciais na camada de containers de api gateway e hub de integracao
...
## Diagrama
[API Gateway - Pipes and Filters Container View (Azure / Go / gRPC)](./api-gateway-pipes-filters-go-grpc-container.mmd)
