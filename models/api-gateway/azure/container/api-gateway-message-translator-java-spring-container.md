# API Gateway - Message Translator Container View [Azure / Java 21 / Spring Boot 3]
...
## Descrição
Traduz mensagens entre formatos diferentes via modelo canonico na camada de containers de api gateway e hub de integracao

## Componentes Principais
- **API Gateway Service** — serviço principal rodando em App Service
...
## Diagrama
[API Gateway - Message Translator Container View (Azure / Java 21 / Spring Boot 3)](./api-gateway-message-translator-java-spring-container.mmd)
