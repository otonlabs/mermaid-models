# API Gateway - Hexagonal Architecture Container View [Azure / Node.js / NestJS]
...
## Descrição
Ports and Adapters para isolamento de dominio nos containers de api gateway e hub de integracao
...
## Diagrama
[API Gateway - Hexagonal Architecture Container View (Azure / Node.js / NestJS)](./api-gateway-hexagonal-node-nestjs-container.mmd)
