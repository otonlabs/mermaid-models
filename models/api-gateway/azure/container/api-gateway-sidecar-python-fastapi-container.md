# API Gateway - Sidecar Pattern Container View [Azure / Python / FastAPI]
...
## Diagrama
[API Gateway - Sidecar Pattern Container View (Azure / Python / FastAPI)](./api-gateway-sidecar-python-fastapi-container.mmd)
