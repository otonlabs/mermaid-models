# API Gateway - Cqrs Es - Component View [Azure / Python / FastAPI]
...
## Diagrama
[API Gateway - Cqrs Es - Component View (Azure / Python / FastAPI)](./api-gateway-cqrs-es-python-fastapi-component.mmd)
