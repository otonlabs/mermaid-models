# API Gateway - Saga Choreography - Component View [Azure / Java 21 / Spring Boot 3]
...
## Diagrama
[API Gateway - Saga Choreography - Component View (Azure / Java 21 / Spring Boot 3)](./api-gateway-saga-choreography-java-spring-component.mmd)
