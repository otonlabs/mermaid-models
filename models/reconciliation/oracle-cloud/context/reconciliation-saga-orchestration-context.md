# Reconciliation com Saga Orchestration [Oracle Cloud]
...
- **Reconciliation Platform** — sistema principal (Coordena transacoes distribuidas via orquestrador central no contexto de reconci)
...
## Diagrama
[Reconciliation com Saga Orchestration (Oracle Cloud)](./reconciliation-saga-orchestration-context.mmd)
