# Reconciliation - Message Translator Container View [AWS / Java 21 / Spring Boot 3]
...
- **Reconciliation Service** — serviço principal rodando em ECS Fargate
...
## Diagrama
[Reconciliation - Message Translator Container View (AWS / Java 21 / Spring Boot 3)](./reconciliation-message-translator-java-spring-container.mmd)
