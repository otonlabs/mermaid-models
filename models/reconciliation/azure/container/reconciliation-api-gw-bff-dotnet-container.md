# Reconciliation - API Gateway BFF Container View [Azure / .NET 8 / ASP.NET Core]
...
## Diagrama
[Reconciliation - API Gateway BFF Container View (Azure / .NET 8 / ASP.NET Core)](./reconciliation-api-gw-bff-dotnet-container.mmd)
