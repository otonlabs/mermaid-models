# Reconciliation - Bulkhead Pattern Container View [Azure / Go / gRPC]
...
## Descrição
Isola recursos criticos para prevenir falhas em cascata nos containers de reconciliacao financeira
...
## Diagrama
[Reconciliation - Bulkhead Pattern Container View (Azure / Go / gRPC)](./reconciliation-bulkhead-go-grpc-container.mmd)
