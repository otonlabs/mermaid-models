# Reconciliation - Sidecar Pattern Container View [Azure / Python / FastAPI]
...
## Descrição
Deploy de componentes auxiliares ao lado do servico principal nos containers de reconciliacao financeira
...
## Diagrama
[Reconciliation - Sidecar Pattern Container View (Azure / Python / FastAPI)](./reconciliation-sidecar-python-fastapi-container.mmd)
