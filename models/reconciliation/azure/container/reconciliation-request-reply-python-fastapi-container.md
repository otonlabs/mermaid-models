# Reconciliation - Request-Reply Container View [Azure / Python / FastAPI]
...
## Descrição
Envia requisicao e aguarda resposta correlacionada na camada de containers de reconciliacao financeira
...
## Diagrama
[Reconciliation - Request-Reply Container View (Azure / Python / FastAPI)](./reconciliation-request-reply-python-fastapi-container.mmd)
