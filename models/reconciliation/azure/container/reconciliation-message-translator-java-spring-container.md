# Reconciliation - Message Translator Container View [Azure / Java 21 / Spring Boot 3]
...
## Descrição
Traduz mensagens entre formatos diferentes via modelo canonico na camada de containers de reconciliacao financeira

## Componentes Principais
- **Reconciliation Service** — serviço principal rodando em App Service
...
## Diagrama
[Reconciliation - Message Translator Container View (Azure / Java 21 / Spring Boot 3)](./reconciliation-message-translator-java-spring-container.mmd)
