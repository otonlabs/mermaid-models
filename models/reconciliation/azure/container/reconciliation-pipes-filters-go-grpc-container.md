# Reconciliation - Pipes and Filters Container View [Azure / Go / gRPC]
...
## Descrição
Processa mensagens atraves de pipeline de filtros sequenciais na camada de containers de reconciliacao financeira
...
## Diagrama
[Reconciliation - Pipes and Filters Container View (Azure / Go / gRPC)](./reconciliation-pipes-filters-go-grpc-container.mmd)
