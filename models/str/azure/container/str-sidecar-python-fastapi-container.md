# STR - Sidecar Pattern Container View [Azure / Python / FastAPI]
...
## Descrição
Deploy de componentes auxiliares ao lado do servico principal nos containers de sistema de transferencia de reservas
...
## Diagrama
[STR - Sidecar Pattern Container View (Azure / Python / FastAPI)](./str-sidecar-python-fastapi-container.mmd)
