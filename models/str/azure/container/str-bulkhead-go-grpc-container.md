# STR - Bulkhead Pattern Container View [Azure / Go / gRPC]
...
## Descrição
Isola recursos criticos para prevenir falhas em cascata nos containers de sistema de transferencia de reservas
...
## Diagrama
[STR - Bulkhead Pattern Container View (Azure / Go / gRPC)](./str-bulkhead-go-grpc-container.mmd)
