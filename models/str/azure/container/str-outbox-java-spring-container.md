# STR - Outbox Pattern Container View [Azure / Java 21 / Spring Boot 3]
...
## Descrição
Garante publicacao confiavel de mensagens via transactional outbox nos containers de sistema de transferencia de reservas
...
## Diagrama
[STR - Outbox Pattern Container View (Azure / Java 21 / Spring Boot 3)](./str-outbox-java-spring-container.mmd)
