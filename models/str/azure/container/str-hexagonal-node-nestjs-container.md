# STR - Hexagonal Architecture Container View [Azure / Node.js / NestJS]
...
## Descrição
Ports and Adapters para isolamento de dominio nos containers de sistema de transferencia de reservas
...
## Diagrama
[STR - Hexagonal Architecture Container View (Azure / Node.js / NestJS)](./str-hexagonal-node-nestjs-container.mmd)
