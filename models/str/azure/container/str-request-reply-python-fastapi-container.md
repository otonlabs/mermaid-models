# STR - Request-Reply Container View [Azure / Python / FastAPI]
...
## Descrição
Envia requisicao e aguarda resposta correlacionada na camada de containers de sistema de transferencia de reservas
...
## Diagrama
[STR - Request-Reply Container View (Azure / Python / FastAPI)](./str-request-reply-python-fastapi-container.mmd)
