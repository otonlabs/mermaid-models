# STR - API Gateway BFF Container View [Azure / .NET 8 / ASP.NET Core]
...
## Descrição
Backend-for-Frontend com API Gateway por canal nos containers de sistema de transferencia de reservas
...
## Diagrama
[STR - API Gateway BFF Container View (Azure / .NET 8 / ASP.NET Core)](./str-api-gw-bff-dotnet-container.mmd)
