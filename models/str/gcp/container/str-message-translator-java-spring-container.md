# STR - Message Translator Container View [GCP / Java 21 / Spring Boot 3]
...
## Diagrama
[STR - Message Translator Container View (GCP / Java 21 / Spring Boot 3)](./str-message-translator-java-spring-container.mmd)
