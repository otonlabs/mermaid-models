# STR - API Gateway BFF Container View [Oracle Cloud / .NET 8 / ASP.NET Core]
...
## Diagrama
[STR - API Gateway BFF Container View (Oracle Cloud / .NET 8 / ASP.NET Core)](./str-api-gw-bff-dotnet-container.mmd)
