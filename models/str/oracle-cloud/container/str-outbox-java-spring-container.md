# STR - Outbox Pattern Container View [Oracle Cloud / Java 21 / Spring Boot 3]
...
## Diagrama
[STR - Outbox Pattern Container View (Oracle Cloud / Java 21 / Spring Boot 3)](./str-outbox-java-spring-container.mmd)
