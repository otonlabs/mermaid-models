# STR - Scatter-Gather Container View [Oracle Cloud / .NET 8 / ASP.NET Core]
...
## Diagrama
[STR - Scatter-Gather Container View (Oracle Cloud / .NET 8 / ASP.NET Core)](./str-scatter-gather-dotnet-container.mmd)
