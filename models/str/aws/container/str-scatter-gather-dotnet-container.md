# STR - Scatter-Gather Container View [AWS / .NET 8 / ASP.NET Core]
...
- **STR Service** — serviço principal rodando em ECS Fargate
...
## Diagrama
[STR - Scatter-Gather Container View (AWS / .NET 8 / ASP.NET Core)](./str-scatter-gather-dotnet-container.mmd)
