# STR - Outbox Pattern Container View [AWS / Java 21 / Spring Boot 3]
...
## Diagrama
[STR - Outbox Pattern Container View (AWS / Java 21 / Spring Boot 3)](./str-outbox-java-spring-container.mmd)
