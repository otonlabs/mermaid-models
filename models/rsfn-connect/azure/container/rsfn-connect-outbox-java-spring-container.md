# RSFN Connect - Outbox Pattern Container View [Azure / Java 21 / Spring Boot 3]
...
## Diagrama
[RSFN Connect - Outbox Pattern Container View (Azure / Java 21 / Spring Boot 3)](./rsfn-connect-outbox-java-spring-container.mmd)
