# RSFN Connect - Competing Consumers Container View [Azure / Node.js / NestJS]
...
- **RSFN Connect Service** — serviço principal rodando em App Service
...
## Diagrama
[RSFN Connect - Competing Consumers Container View (Azure / Node.js / NestJS)](./rsfn-connect-competing-consumers-node-nestjs-container.mmd)
