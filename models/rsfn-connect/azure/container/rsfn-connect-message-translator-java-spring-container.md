# RSFN Connect - Message Translator Container View [Azure / Java 21 / Spring Boot 3]
...
## Diagrama
[RSFN Connect - Message Translator Container View (Azure / Java 21 / Spring Boot 3)](./rsfn-connect-message-translator-java-spring-container.mmd)
