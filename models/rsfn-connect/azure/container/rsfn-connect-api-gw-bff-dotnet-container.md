# RSFN Connect - API Gateway BFF Container View [Azure / .NET 8 / ASP.NET Core]
...
## Diagrama
[RSFN Connect - API Gateway BFF Container View (Azure / .NET 8 / ASP.NET Core)](./rsfn-connect-api-gw-bff-dotnet-container.mmd)
