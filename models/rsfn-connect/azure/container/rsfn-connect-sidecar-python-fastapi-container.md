# RSFN Connect - Sidecar Pattern Container View [Azure / Python / FastAPI]
...
## Diagrama
[RSFN Connect - Sidecar Pattern Container View (Azure / Python / FastAPI)](./rsfn-connect-sidecar-python-fastapi-container.mmd)
