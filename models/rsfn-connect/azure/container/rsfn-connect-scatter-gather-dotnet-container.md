# RSFN Connect - Scatter-Gather Container View [Azure / .NET 8 / ASP.NET Core]
...
## Diagrama
[RSFN Connect - Scatter-Gather Container View (Azure / .NET 8 / ASP.NET Core)](./rsfn-connect-scatter-gather-dotnet-container.mmd)
