# RSFN Connect - Request-Reply Container View [Azure / Python / FastAPI]
...
## Diagrama
[RSFN Connect - Request-Reply Container View (Azure / Python / FastAPI)](./rsfn-connect-request-reply-python-fastapi-container.mmd)
