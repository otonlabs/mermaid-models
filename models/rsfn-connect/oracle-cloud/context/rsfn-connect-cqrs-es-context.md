# RSFN Connect com CQRS + Event Sourcing [Oracle Cloud]
...
- **RSFN Connect Platform** — sistema principal (Separa modelos de leitura e escrita com estado baseado em eventos no contexto de)
...
## Diagrama
[RSFN Connect com CQRS + Event Sourcing (Oracle Cloud)](./rsfn-connect-cqrs-es-context.mmd)
