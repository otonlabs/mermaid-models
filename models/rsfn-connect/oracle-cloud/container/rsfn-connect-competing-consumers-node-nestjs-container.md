# RSFN Connect - Competing Consumers Container View [Oracle Cloud / Node.js / NestJS]
...
## Descrição
Multiplos consumidores competem para processar mensagens de fila compartilhada na camada de containers de rede do sistema financeiro nacional

## Componentes Principais
- **RSFN Connect Service** — serviço principal rodando em OKE
...
## Diagrama
[RSFN Connect - Competing Consumers Container View (Oracle Cloud / Node.js / NestJS)](./rsfn-connect-competing-consumers-node-nestjs-container.mmd)
