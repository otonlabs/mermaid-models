# RSFN Connect - Hexagonal Architecture Container View [Oracle Cloud / Node.js / NestJS]
...
## Descrição
Ports and Adapters para isolamento de dominio nos containers de rede do sistema financeiro nacional
...
## Diagrama
[RSFN Connect - Hexagonal Architecture Container View (Oracle Cloud / Node.js / NestJS)](./rsfn-connect-hexagonal-node-nestjs-container.mmd)
