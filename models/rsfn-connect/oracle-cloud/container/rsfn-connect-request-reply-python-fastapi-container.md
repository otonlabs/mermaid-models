# RSFN Connect - Request-Reply Container View [Oracle Cloud / Python / FastAPI]
...
## Descrição
Envia requisicao e aguarda resposta correlacionada na camada de containers de rede do sistema financeiro nacional
...
## Diagrama
[RSFN Connect - Request-Reply Container View (Oracle Cloud / Python / FastAPI)](./rsfn-connect-request-reply-python-fastapi-container.mmd)
