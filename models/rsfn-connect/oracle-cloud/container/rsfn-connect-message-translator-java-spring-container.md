# RSFN Connect - Message Translator Container View [Oracle Cloud / Java 21 / Spring Boot 3]
...
## Descrição
Traduz mensagens entre formatos diferentes via modelo canonico na camada de containers de rede do sistema financeiro nacional
...
## Diagrama
[RSFN Connect - Message Translator Container View (Oracle Cloud / Java 21 / Spring Boot 3)](./rsfn-connect-message-translator-java-spring-container.mmd)
