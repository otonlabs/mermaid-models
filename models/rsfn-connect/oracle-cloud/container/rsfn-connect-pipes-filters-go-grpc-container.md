# RSFN Connect - Pipes and Filters Container View [Oracle Cloud / Go / gRPC]
...
## Descrição
Processa mensagens atraves de pipeline de filtros sequenciais na camada de containers de rede do sistema financeiro nacional
...
## Diagrama
[RSFN Connect - Pipes and Filters Container View (Oracle Cloud / Go / gRPC)](./rsfn-connect-pipes-filters-go-grpc-container.mmd)
