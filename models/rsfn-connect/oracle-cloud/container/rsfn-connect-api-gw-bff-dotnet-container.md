# RSFN Connect - API Gateway BFF Container View [Oracle Cloud / .NET 8 / ASP.NET Core]
...
## Descrição
Backend-for-Frontend com API Gateway por canal nos containers de rede do sistema financeiro nacional
...
## Diagrama
[RSFN Connect - API Gateway BFF Container View (Oracle Cloud / .NET 8 / ASP.NET Core)](./rsfn-connect-api-gw-bff-dotnet-container.mmd)
