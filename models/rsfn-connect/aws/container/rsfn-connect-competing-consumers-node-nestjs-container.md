# RSFN Connect - Competing Consumers Container View [AWS / Node.js / NestJS]
...
- **RSFN Connect Service** — serviço principal rodando em ECS Fargate
...
## Diagrama
[RSFN Connect - Competing Consumers Container View (AWS / Node.js / NestJS)](./rsfn-connect-competing-consumers-node-nestjs-container.mmd)
