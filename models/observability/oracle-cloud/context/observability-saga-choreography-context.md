# Observability com Saga Choreography [Oracle Cloud]
...
- **Observability Platform** — sistema principal (Coordena transacoes distribuidas via coreografia de eventos no contexto de obser)
...
## Diagrama
[Observability com Saga Choreography (Oracle Cloud)](./observability-saga-choreography-context.mmd)
