# Observability - API Gateway BFF Container View [Azure / .NET 8 / ASP.NET Core]
...
## Diagrama
[Observability - API Gateway BFF Container View (Azure / .NET 8 / ASP.NET Core)](./observability-api-gw-bff-dotnet-container.mmd)
