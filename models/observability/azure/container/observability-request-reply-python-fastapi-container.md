# Observability - Request-Reply Container View [Azure / Python / FastAPI]
...
## Descrição
Envia requisicao e aguarda resposta correlacionada na camada de containers de observabilidade e monitoramento
...
## Diagrama
[Observability - Request-Reply Container View (Azure / Python / FastAPI)](./observability-request-reply-python-fastapi-container.mmd)
