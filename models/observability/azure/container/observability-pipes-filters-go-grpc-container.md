# Observability - Pipes and Filters Container View [Azure / Go / gRPC]
...
## Descrição
Processa mensagens atraves de pipeline de filtros sequenciais na camada de containers de observabilidade e monitoramento
...
## Diagrama
[Observability - Pipes and Filters Container View (Azure / Go / gRPC)](./observability-pipes-filters-go-grpc-container.mmd)
