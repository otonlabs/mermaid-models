# Observability - Competing Consumers Container View [Azure / Node.js / NestJS]
...
## Descrição
Multiplos consumidores competem para processar mensagens de fila compartilhada na camada de containers de observabilidade e monitoramento

## Componentes Principais
- **Observability Service** — serviço principal rodando em App Service
...
## Diagrama
[Observability - Competing Consumers Container View (Azure / Node.js / NestJS)](./observability-competing-consumers-node-nestjs-container.mmd)
