# Observability - Sidecar Pattern Container View [Azure / Python / FastAPI]
...
## Descrição
Deploy de componentes auxiliares ao lado do servico principal nos containers de observabilidade e monitoramento
...
## Diagrama
[Observability - Sidecar Pattern Container View (Azure / Python / FastAPI)](./observability-sidecar-python-fastapi-container.mmd)
