# Observability - Bulkhead Pattern Container View [Azure / Go / gRPC]
...
## Descrição
Isola recursos criticos para prevenir falhas em cascata nos containers de observabilidade e monitoramento
...
## Diagrama
[Observability - Bulkhead Pattern Container View (Azure / Go / gRPC)](./observability-bulkhead-go-grpc-container.mmd)
