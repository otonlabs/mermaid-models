# Observability - Message Translator Container View [Azure / Java 21 / Spring Boot 3]
...
## Diagrama
[Observability - Message Translator Container View (Azure / Java 21 / Spring Boot 3)](./observability-message-translator-java-spring-container.mmd)
