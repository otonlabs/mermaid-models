# TEF - Message Translator Container View [Azure / Java 21 / Spring Boot 3]
...
## Diagrama
[TEF - Message Translator Container View (Azure / Java 21 / Spring Boot 3)](./tef-message-translator-java-spring-container.mmd)
