# TEF com Content-Based Router [Oracle Cloud]
...
- **TEF Platform** — sistema principal (Roteia mensagens para canais diferentes baseado no conteudo aplicado ao contexto)
...
## Diagrama
[TEF com Content-Based Router (Oracle Cloud)](./tef-content-based-router-context.mmd)
