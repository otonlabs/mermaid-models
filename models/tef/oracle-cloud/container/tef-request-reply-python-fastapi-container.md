# TEF - Request-Reply Container View [Oracle Cloud / Python / FastAPI]
...
## Descrição
Envia requisicao e aguarda resposta correlacionada na camada de containers de transferencia eletronica de fundos
...
## Diagrama
[TEF - Request-Reply Container View (Oracle Cloud / Python / FastAPI)](./tef-request-reply-python-fastapi-container.mmd)
