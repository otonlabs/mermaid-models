# TEF - Scatter-Gather Container View [Oracle Cloud / .NET 8 / ASP.NET Core]
...
## Diagrama
[TEF - Scatter-Gather Container View (Oracle Cloud / .NET 8 / ASP.NET Core)](./tef-scatter-gather-dotnet-container.mmd)
