# TEF - Pipes and Filters Container View [Oracle Cloud / Go / gRPC]
...
## Descrição
Processa mensagens atraves de pipeline de filtros sequenciais na camada de containers de transferencia eletronica de fundos
...
## Diagrama
[TEF - Pipes and Filters Container View (Oracle Cloud / Go / gRPC)](./tef-pipes-filters-go-grpc-container.mmd)
