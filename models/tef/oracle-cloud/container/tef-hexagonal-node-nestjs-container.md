# TEF - Hexagonal Architecture Container View [Oracle Cloud / Node.js / NestJS]
...
## Descrição
Ports and Adapters para isolamento de dominio nos containers de transferencia eletronica de fundos
...
## Diagrama
[TEF - Hexagonal Architecture Container View (Oracle Cloud / Node.js / NestJS)](./tef-hexagonal-node-nestjs-container.mmd)
