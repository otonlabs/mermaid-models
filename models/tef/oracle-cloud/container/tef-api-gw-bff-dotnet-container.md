# TEF - API Gateway BFF Container View [Oracle Cloud / .NET 8 / ASP.NET Core]
...
## Descrição
Backend-for-Frontend com API Gateway por canal nos containers de transferencia eletronica de fundos
...
## Diagrama
[TEF - API Gateway BFF Container View (Oracle Cloud / .NET 8 / ASP.NET Core)](./tef-api-gw-bff-dotnet-container.mmd)
