# TEF - Sidecar Pattern Container View [Oracle Cloud / Python / FastAPI]
...
## Descrição
Deploy de componentes auxiliares ao lado do servico principal nos containers de transferencia eletronica de fundos
...
## Diagrama
[TEF - Sidecar Pattern Container View (Oracle Cloud / Python / FastAPI)](./tef-sidecar-python-fastapi-container.mmd)
