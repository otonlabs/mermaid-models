# TEF - API Gateway BFF Container View [AWS / .NET 8 / ASP.NET Core]
...
## Diagrama
[TEF - API Gateway BFF Container View (AWS / .NET 8 / ASP.NET Core)](./tef-api-gw-bff-dotnet-container.mmd)
