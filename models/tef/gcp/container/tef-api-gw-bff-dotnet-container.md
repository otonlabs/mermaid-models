# TEF - API Gateway BFF Container View [GCP / .NET 8 / ASP.NET Core]
...
## Diagrama
[TEF - API Gateway BFF Container View (GCP / .NET 8 / ASP.NET Core)](./tef-api-gw-bff-dotnet-container.mmd)
