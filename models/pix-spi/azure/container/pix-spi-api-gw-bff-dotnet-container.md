# BFF para Canais PIX (Mobile, Web, API) [Azure / .NET 8 / ASP.NET Core]
...
## Diagrama
[BFF para Canais PIX (Mobile, Web, API) (Azure / .NET 8 / ASP.NET Core)](./pix-spi-api-gw-bff-dotnet-container.mmd)
