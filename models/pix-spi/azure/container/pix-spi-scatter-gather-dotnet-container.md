# Consulta de Tarifa PIX via Scatter-Gather [Azure / .NET 8 / ASP.NET Core]
...
## Diagrama
[Consulta de Tarifa PIX via Scatter-Gather (Azure / .NET 8 / ASP.NET Core)](./pix-spi-scatter-gather-dotnet-container.mmd)
