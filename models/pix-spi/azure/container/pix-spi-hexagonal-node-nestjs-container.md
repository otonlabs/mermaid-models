# Hexagonal Architecture para Payment Domain [Azure / Node.js / NestJS]
...
## Diagrama
[Hexagonal Architecture para Payment Domain (Azure / Node.js / NestJS)](./pix-spi-hexagonal-node-nestjs-container.mmd)
