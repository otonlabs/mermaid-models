# Pool de Workers SPI com Competing Consumers [Azure / Node.js / NestJS]
...
## Diagrama
[Pool de Workers SPI com Competing Consumers (Azure / Node.js / NestJS)](./pix-spi-competing-consumers-node-nestjs-container.mmd)
