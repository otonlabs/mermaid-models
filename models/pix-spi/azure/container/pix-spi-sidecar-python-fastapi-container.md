# Sidecar para Criptografia SPI [Azure / Python / FastAPI]
...
## Descrição
Sidecar com HSM integration para assinatura digital de mensagens SPI
...
## Diagrama
[Sidecar para Criptografia SPI (Azure / Python / FastAPI)](./pix-spi-sidecar-python-fastapi-container.mmd)
