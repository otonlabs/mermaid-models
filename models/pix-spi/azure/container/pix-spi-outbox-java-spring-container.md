# Outbox para Eventos de Pagamento PIX [Azure / Java 21 / Spring Boot 3]
...
## Diagrama
[Outbox para Eventos de Pagamento PIX (Azure / Java 21 / Spring Boot 3)](./pix-spi-outbox-java-spring-container.mmd)
