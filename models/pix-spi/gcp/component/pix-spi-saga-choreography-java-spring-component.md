# PIX SPI - Saga Choreography - Component View [GCP / Java 21 / Spring Boot 3]
...
## Diagrama
[PIX SPI - Saga Choreography - Component View (GCP / Java 21 / Spring Boot 3)](./pix-spi-saga-choreography-java-spring-component.mmd)
