# Outbox para Eventos de Pagamento PIX [GCP / Java 21 / Spring Boot 3]
...
## Diagrama
[Outbox para Eventos de Pagamento PIX (GCP / Java 21 / Spring Boot 3)](./pix-spi-outbox-java-spring-container.mmd)
