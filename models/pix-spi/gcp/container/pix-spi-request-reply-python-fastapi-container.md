# Confirmacao Sincrona SPI via Request-Reply [GCP / Python / FastAPI]
...
## Diagrama
[Confirmacao Sincrona SPI via Request-Reply (GCP / Python / FastAPI)](./pix-spi-request-reply-python-fastapi-container.mmd)
