# PIX SPI - Splitter Aggregator - Component View [Oracle Cloud / Python / FastAPI]
...
## Diagrama
[PIX SPI - Splitter Aggregator - Component View (Oracle Cloud / Python / FastAPI)](./pix-spi-splitter-aggregator-python-fastapi-component.mmd)
