# PIX SPI - Pub Sub - Component View [Oracle Cloud / .NET 8 / ASP.NET Core]
...
## Diagrama
[PIX SPI - Pub Sub - Component View (Oracle Cloud / .NET 8 / ASP.NET Core)](./pix-spi-pub-sub-dotnet-component.mmd)
