# Outbox para Eventos de Pagamento PIX [Oracle Cloud / Java 21 / Spring Boot 3]
...
## Diagrama
[Outbox para Eventos de Pagamento PIX (Oracle Cloud / Java 21 / Spring Boot 3)](./pix-spi-outbox-java-spring-container.mmd)
