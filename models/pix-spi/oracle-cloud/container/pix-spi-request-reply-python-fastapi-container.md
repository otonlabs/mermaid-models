# Confirmacao Sincrona SPI via Request-Reply [Oracle Cloud / Python / FastAPI]
...
## Diagrama
[Confirmacao Sincrona SPI via Request-Reply (Oracle Cloud / Python / FastAPI)](./pix-spi-request-reply-python-fastapi-container.mmd)
