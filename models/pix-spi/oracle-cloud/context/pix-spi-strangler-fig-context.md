# Migracao para Novo Motor PIX via Strangler Fig [Oracle Cloud]
...
## Diagrama
[Migracao para Novo Motor PIX via Strangler Fig (Oracle Cloud)](./pix-spi-strangler-fig-context.mmd)
