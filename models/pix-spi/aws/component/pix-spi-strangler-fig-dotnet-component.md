# PIX SPI - Strangler Fig - Component View [AWS / .NET 8 / ASP.NET Core]
...
## Diagrama
[PIX SPI - Strangler Fig - Component View (AWS / .NET 8 / ASP.NET Core)](./pix-spi-strangler-fig-dotnet-component.mmd)
