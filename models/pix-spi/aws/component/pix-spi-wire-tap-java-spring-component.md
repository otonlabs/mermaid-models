# PIX SPI - Wire Tap - Component View [AWS / Java 21 / Spring Boot 3]
...
## Diagrama
[PIX SPI - Wire Tap - Component View (AWS / Java 21 / Spring Boot 3)](./pix-spi-wire-tap-java-spring-component.mmd)
