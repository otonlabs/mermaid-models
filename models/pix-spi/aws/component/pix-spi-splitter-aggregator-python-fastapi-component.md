# PIX SPI - Splitter Aggregator - Component View [AWS / Python / FastAPI]
...
## Diagrama
[PIX SPI - Splitter Aggregator - Component View (AWS / Python / FastAPI)](./pix-spi-splitter-aggregator-python-fastapi-component.mmd)
