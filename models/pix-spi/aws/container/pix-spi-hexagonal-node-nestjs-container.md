# Hexagonal Architecture para Payment Domain [AWS / Node.js / NestJS]
...
## Diagrama
[Hexagonal Architecture para Payment Domain (AWS / Node.js / NestJS)](./pix-spi-hexagonal-node-nestjs-container.mmd)
