# Pool de Workers SPI com Competing Consumers [AWS / Node.js / NestJS]
...
## Diagrama
[Pool de Workers SPI com Competing Consumers (AWS / Node.js / NestJS)](./pix-spi-competing-consumers-node-nestjs-container.mmd)
