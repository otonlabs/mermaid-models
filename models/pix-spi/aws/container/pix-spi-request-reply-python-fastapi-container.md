# Confirmacao Sincrona SPI via Request-Reply [AWS / Python / FastAPI]
...
## Diagrama
[Confirmacao Sincrona SPI via Request-Reply (AWS / Python / FastAPI)](./pix-spi-request-reply-python-fastapi-container.mmd)
