# KYC AML - Splitter Aggregator - Component View [AWS / Python / FastAPI]
...
## Diagrama
[KYC AML - Splitter Aggregator - Component View (AWS / Python / FastAPI)](./kyc-aml-splitter-aggregator-python-fastapi-component.mmd)
