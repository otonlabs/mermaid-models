# KYC AML - Request-Reply Container View [AWS / Python / FastAPI]
...
## Diagrama
[KYC AML - Request-Reply Container View (AWS / Python / FastAPI)](./kyc-aml-request-reply-python-fastapi-container.mmd)
