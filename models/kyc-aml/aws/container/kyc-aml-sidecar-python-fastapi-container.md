# KYC AML - Sidecar Pattern Container View [AWS / Python / FastAPI]
...
## Diagrama
[KYC AML - Sidecar Pattern Container View (AWS / Python / FastAPI)](./kyc-aml-sidecar-python-fastapi-container.mmd)
