# KYC AML - Competing Consumers Container View [AWS / Node.js / NestJS]
...
- **KYC AML Service** — serviço principal rodando em ECS Fargate
...
## Diagrama
[KYC AML - Competing Consumers Container View (AWS / Node.js / NestJS)](./kyc-aml-competing-consumers-node-nestjs-container.mmd)
