# KYC AML - API Gateway BFF Container View [AWS / .NET 8 / ASP.NET Core]
...
## Diagrama
[KYC AML - API Gateway BFF Container View (AWS / .NET 8 / ASP.NET Core)](./kyc-aml-api-gw-bff-dotnet-container.mmd)
