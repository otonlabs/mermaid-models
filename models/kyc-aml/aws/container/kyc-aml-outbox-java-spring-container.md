# KYC AML - Outbox Pattern Container View [AWS / Java 21 / Spring Boot 3]
...
## Diagrama
[KYC AML - Outbox Pattern Container View (AWS / Java 21 / Spring Boot 3)](./kyc-aml-outbox-java-spring-container.mmd)
