# KYC AML - Bulkhead Pattern Container View [Oracle Cloud / Go / gRPC]
...
## Descrição
Isola recursos criticos para prevenir falhas em cascata nos containers de know your customer e anti-lavagem
...
## Diagrama
[KYC AML - Bulkhead Pattern Container View (Oracle Cloud / Go / gRPC)](./kyc-aml-bulkhead-go-grpc-container.mmd)
