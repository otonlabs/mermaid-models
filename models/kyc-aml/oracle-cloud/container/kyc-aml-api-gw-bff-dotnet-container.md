# KYC AML - API Gateway BFF Container View [Oracle Cloud / .NET 8 / ASP.NET Core]
...
## Descrição
Backend-for-Frontend com API Gateway por canal nos containers de know your customer e anti-lavagem
...
## Diagrama
[KYC AML - API Gateway BFF Container View (Oracle Cloud / .NET 8 / ASP.NET Core)](./kyc-aml-api-gw-bff-dotnet-container.mmd)
