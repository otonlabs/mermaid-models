# KYC AML - Scatter-Gather Container View [Oracle Cloud / .NET 8 / ASP.NET Core]
...
## Diagrama
[KYC AML - Scatter-Gather Container View (Oracle Cloud / .NET 8 / ASP.NET Core)](./kyc-aml-scatter-gather-dotnet-container.mmd)
