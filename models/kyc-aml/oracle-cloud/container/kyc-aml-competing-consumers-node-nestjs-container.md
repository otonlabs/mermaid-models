# KYC AML - Competing Consumers Container View [Oracle Cloud / Node.js / NestJS]
...
## Descrição
Multiplos consumidores competem para processar mensagens de fila compartilhada na camada de containers de know your customer e anti-lavagem

## Componentes Principais
- **KYC AML Service** — serviço principal rodando em OKE
...
## Diagrama
[KYC AML - Competing Consumers Container View (Oracle Cloud / Node.js / NestJS)](./kyc-aml-competing-consumers-node-nestjs-container.mmd)
