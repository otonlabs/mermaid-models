# KYC AML - Request-Reply Container View [Oracle Cloud / Python / FastAPI]
...
## Descrição
Envia requisicao e aguarda resposta correlacionada na camada de containers de know your customer e anti-lavagem
...
## Diagrama
[KYC AML - Request-Reply Container View (Oracle Cloud / Python / FastAPI)](./kyc-aml-request-reply-python-fastapi-container.mmd)
