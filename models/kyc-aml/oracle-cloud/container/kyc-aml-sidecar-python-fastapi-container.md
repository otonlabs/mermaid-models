# KYC AML - Sidecar Pattern Container View [Oracle Cloud / Python / FastAPI]
...
## Descrição
Deploy de componentes auxiliares ao lado do servico principal nos containers de know your customer e anti-lavagem
...
## Diagrama
[KYC AML - Sidecar Pattern Container View (Oracle Cloud / Python / FastAPI)](./kyc-aml-sidecar-python-fastapi-container.mmd)
