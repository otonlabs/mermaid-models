# KYC AML - Hexagonal Architecture Container View [Oracle Cloud / Node.js / NestJS]
...
## Descrição
Ports and Adapters para isolamento de dominio nos containers de know your customer e anti-lavagem
...
## Diagrama
[KYC AML - Hexagonal Architecture Container View (Oracle Cloud / Node.js / NestJS)](./kyc-aml-hexagonal-node-nestjs-container.mmd)
