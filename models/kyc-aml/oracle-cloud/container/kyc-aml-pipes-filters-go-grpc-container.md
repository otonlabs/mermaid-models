# KYC AML - Pipes and Filters Container View [Oracle Cloud / Go / gRPC]
...
## Descrição
Processa mensagens atraves de pipeline de filtros sequenciais na camada de containers de know your customer e anti-lavagem
...
## Diagrama
[KYC AML - Pipes and Filters Container View (Oracle Cloud / Go / gRPC)](./kyc-aml-pipes-filters-go-grpc-container.mmd)
