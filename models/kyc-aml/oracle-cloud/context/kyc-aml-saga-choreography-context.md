# KYC AML com Saga Choreography [Oracle Cloud]
...
- **KYC AML Platform** — sistema principal (Coordena transacoes distribuidas via coreografia de eventos no contexto de know )
...
## Diagrama
[KYC AML com Saga Choreography (Oracle Cloud)](./kyc-aml-saga-choreography-context.mmd)
