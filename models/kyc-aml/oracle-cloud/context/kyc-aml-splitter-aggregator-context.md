# KYC AML com Splitter-Aggregator [Oracle Cloud]
...
- **KYC AML Platform** — sistema principal (Divide mensagens compostas e agrega respostas aplicado ao contexto de know your )
...
## Diagrama
[KYC AML com Splitter-Aggregator (Oracle Cloud)](./kyc-aml-splitter-aggregator-context.mmd)
