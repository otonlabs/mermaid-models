# KYC AML - Request-Reply Container View [GCP / Python / FastAPI]
...
## Diagrama
[KYC AML - Request-Reply Container View (GCP / Python / FastAPI)](./kyc-aml-request-reply-python-fastapi-container.mmd)
