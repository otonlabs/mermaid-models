# KYC AML - Outbox Pattern Container View [GCP / Java 21 / Spring Boot 3]
...
## Diagrama
[KYC AML - Outbox Pattern Container View (GCP / Java 21 / Spring Boot 3)](./kyc-aml-outbox-java-spring-container.mmd)
