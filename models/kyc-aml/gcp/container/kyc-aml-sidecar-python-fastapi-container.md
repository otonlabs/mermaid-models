# KYC AML - Sidecar Pattern Container View [GCP / Python / FastAPI]
...
## Diagrama
[KYC AML - Sidecar Pattern Container View (GCP / Python / FastAPI)](./kyc-aml-sidecar-python-fastapi-container.mmd)
