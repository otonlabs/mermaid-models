# KYC AML - Message Translator Container View [Azure / Java 21 / Spring Boot 3]
...
## Diagrama
[KYC AML - Message Translator Container View (Azure / Java 21 / Spring Boot 3)](./kyc-aml-message-translator-java-spring-container.mmd)
