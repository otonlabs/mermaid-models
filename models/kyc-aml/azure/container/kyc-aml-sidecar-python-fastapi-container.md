# KYC AML - Sidecar Pattern Container View [Azure / Python / FastAPI]
...
## Diagrama
[KYC AML - Sidecar Pattern Container View (Azure / Python / FastAPI)](./kyc-aml-sidecar-python-fastapi-container.mmd)
