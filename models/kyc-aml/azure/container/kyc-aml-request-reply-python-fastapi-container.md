# KYC AML - Request-Reply Container View [Azure / Python / FastAPI]
...
## Diagrama
[KYC AML - Request-Reply Container View (Azure / Python / FastAPI)](./kyc-aml-request-reply-python-fastapi-container.mmd)
