# Security IAM - Request-Reply Container View [AWS / Python / FastAPI]
...
## Diagrama
[Security IAM - Request-Reply Container View (AWS / Python / FastAPI)](./security-iam-request-reply-python-fastapi-container.mmd)
