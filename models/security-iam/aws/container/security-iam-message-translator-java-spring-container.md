# Security IAM - Message Translator Container View [AWS / Java 21 / Spring Boot 3]
...
## Diagrama
[Security IAM - Message Translator Container View (AWS / Java 21 / Spring Boot 3)](./security-iam-message-translator-java-spring-container.mmd)
