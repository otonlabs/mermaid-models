# Security IAM - Sidecar Pattern Container View [AWS / Python / FastAPI]
...
## Diagrama
[Security IAM - Sidecar Pattern Container View (AWS / Python / FastAPI)](./security-iam-sidecar-python-fastapi-container.mmd)
