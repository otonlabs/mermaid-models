# Security IAM - Splitter Aggregator - Component View [AWS / Python / FastAPI]
...
## Diagrama
[Security IAM - Splitter Aggregator - Component View (AWS / Python / FastAPI)](./security-iam-splitter-aggregator-python-fastapi-component.mmd)
