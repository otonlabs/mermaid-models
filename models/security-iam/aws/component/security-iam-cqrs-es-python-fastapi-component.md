# Security IAM - Cqrs Es - Component View [AWS / Python / FastAPI]
...
## Diagrama
[Security IAM - Cqrs Es - Component View (AWS / Python / FastAPI)](./security-iam-cqrs-es-python-fastapi-component.mmd)
