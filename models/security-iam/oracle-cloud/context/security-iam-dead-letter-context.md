# Security IAM com Dead Letter Channel [Oracle Cloud]
...
- **Security IAM Platform** — sistema principal (Encaminha mensagens nao processaveis para canal de dead letter aplicado ao conte)
...
## Diagrama
[Security IAM com Dead Letter Channel (Oracle Cloud)](./security-iam-dead-letter-context.mmd)
