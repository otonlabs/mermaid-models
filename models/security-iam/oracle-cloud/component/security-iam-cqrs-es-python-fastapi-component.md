# Security IAM - Cqrs Es - Component View [Oracle Cloud / Python / FastAPI]
...
## Diagrama
[Security IAM - Cqrs Es - Component View (Oracle Cloud / Python / FastAPI)](./security-iam-cqrs-es-python-fastapi-component.mmd)
