# Security IAM - Message Translator Container View [Oracle Cloud / Java 21 / Spring Boot 3]
...
## Descrição
Traduz mensagens entre formatos diferentes via modelo canonico na camada de containers de seguranca e gestao de identidade
...
## Diagrama
[Security IAM - Message Translator Container View (Oracle Cloud / Java 21 / Spring Boot 3)](./security-iam-message-translator-java-spring-container.mmd)
