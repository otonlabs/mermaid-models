# Security IAM - Competing Consumers Container View [Oracle Cloud / Node.js / NestJS]
...
## Descrição
Multiplos consumidores competem para processar mensagens de fila compartilhada na camada de containers de seguranca e gestao de identidade

## Componentes Principais
- **Security IAM Service** — serviço principal rodando em OKE
...
## Diagrama
[Security IAM - Competing Consumers Container View (Oracle Cloud / Node.js / NestJS)](./security-iam-competing-consumers-node-nestjs-container.mmd)
