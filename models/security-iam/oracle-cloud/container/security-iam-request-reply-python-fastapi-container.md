# Security IAM - Request-Reply Container View [Oracle Cloud / Python / FastAPI]
...
## Descrição
Envia requisicao e aguarda resposta correlacionada na camada de containers de seguranca e gestao de identidade
...
## Diagrama
[Security IAM - Request-Reply Container View (Oracle Cloud / Python / FastAPI)](./security-iam-request-reply-python-fastapi-container.mmd)
