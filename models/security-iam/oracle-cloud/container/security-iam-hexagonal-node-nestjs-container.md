# Security IAM - Hexagonal Architecture Container View [Oracle Cloud / Node.js / NestJS]
...
## Descrição
Ports and Adapters para isolamento de dominio nos containers de seguranca e gestao de identidade
...
## Diagrama
[Security IAM - Hexagonal Architecture Container View (Oracle Cloud / Node.js / NestJS)](./security-iam-hexagonal-node-nestjs-container.mmd)
