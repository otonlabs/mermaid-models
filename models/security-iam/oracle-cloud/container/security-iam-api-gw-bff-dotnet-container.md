# Security IAM - API Gateway BFF Container View [Oracle Cloud / .NET 8 / ASP.NET Core]
...
## Descrição
Backend-for-Frontend com API Gateway por canal nos containers de seguranca e gestao de identidade
...
## Diagrama
[Security IAM - API Gateway BFF Container View (Oracle Cloud / .NET 8 / ASP.NET Core)](./security-iam-api-gw-bff-dotnet-container.mmd)
