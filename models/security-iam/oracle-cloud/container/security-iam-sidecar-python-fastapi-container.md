# Security IAM - Sidecar Pattern Container View [Oracle Cloud / Python / FastAPI]
...
## Descrição
Deploy de componentes auxiliares ao lado do servico principal nos containers de seguranca e gestao de identidade
...
## Diagrama
[Security IAM - Sidecar Pattern Container View (Oracle Cloud / Python / FastAPI)](./security-iam-sidecar-python-fastapi-container.mmd)
