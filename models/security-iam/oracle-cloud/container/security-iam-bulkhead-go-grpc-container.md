# Security IAM - Bulkhead Pattern Container View [Oracle Cloud / Go / gRPC]
...
## Descrição
Isola recursos criticos para prevenir falhas em cascata nos containers de seguranca e gestao de identidade
...
## Diagrama
[Security IAM - Bulkhead Pattern Container View (Oracle Cloud / Go / gRPC)](./security-iam-bulkhead-go-grpc-container.mmd)
