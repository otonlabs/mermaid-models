# Security IAM - Competing Consumers Container View [GCP / Node.js / NestJS]
...
- **Security IAM Service** — serviço principal rodando em Cloud Run
...
## Diagrama
[Security IAM - Competing Consumers Container View (GCP / Node.js / NestJS)](./security-iam-competing-consumers-node-nestjs-container.mmd)
