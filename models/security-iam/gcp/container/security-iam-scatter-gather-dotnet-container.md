# Security IAM - Scatter-Gather Container View [GCP / .NET 8 / ASP.NET Core]
...
## Diagrama
[Security IAM - Scatter-Gather Container View (GCP / .NET 8 / ASP.NET Core)](./security-iam-scatter-gather-dotnet-container.mmd)
