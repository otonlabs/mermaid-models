# Security IAM - Request-Reply Container View [GCP / Python / FastAPI]
...
## Diagrama
[Security IAM - Request-Reply Container View (GCP / Python / FastAPI)](./security-iam-request-reply-python-fastapi-container.mmd)
