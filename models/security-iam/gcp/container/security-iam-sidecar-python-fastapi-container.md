# Security IAM - Sidecar Pattern Container View [GCP / Python / FastAPI]
...
## Diagrama
[Security IAM - Sidecar Pattern Container View (GCP / Python / FastAPI)](./security-iam-sidecar-python-fastapi-container.mmd)
