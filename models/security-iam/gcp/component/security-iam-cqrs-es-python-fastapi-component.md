# Security IAM - Cqrs Es - Component View [GCP / Python / FastAPI]
...
## Diagrama
[Security IAM - Cqrs Es - Component View (GCP / Python / FastAPI)](./security-iam-cqrs-es-python-fastapi-component.mmd)
