# Security IAM - Outbox Pattern Container View [Azure / Java 21 / Spring Boot 3]
...
## Diagrama
[Security IAM - Outbox Pattern Container View (Azure / Java 21 / Spring Boot 3)](./security-iam-outbox-java-spring-container.mmd)
