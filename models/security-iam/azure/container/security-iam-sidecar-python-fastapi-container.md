# Security IAM - Sidecar Pattern Container View [Azure / Python / FastAPI]
...
## Diagrama
[Security IAM - Sidecar Pattern Container View (Azure / Python / FastAPI)](./security-iam-sidecar-python-fastapi-container.mmd)
