# Security IAM - API Gateway BFF Container View [Azure / .NET 8 / ASP.NET Core]
...
## Diagrama
[Security IAM - API Gateway BFF Container View (Azure / .NET 8 / ASP.NET Core)](./security-iam-api-gw-bff-dotnet-container.mmd)
