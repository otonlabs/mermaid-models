# Security IAM - Request-Reply Container View [Azure / Python / FastAPI]
...
## Diagrama
[Security IAM - Request-Reply Container View (Azure / Python / FastAPI)](./security-iam-request-reply-python-fastapi-container.mmd)
