# Security IAM - Cqrs Es - Component View [Azure / Python / FastAPI]
...
## Diagrama
[Security IAM - Cqrs Es - Component View (Azure / Python / FastAPI)](./security-iam-cqrs-es-python-fastapi-component.mmd)
