# Open Banking - Hexagonal Architecture Container View [Azure / Node.js / NestJS]
...
## Diagrama
[Open Banking - Hexagonal Architecture Container View (Azure / Node.js / NestJS)](./open-banking-hexagonal-node-nestjs-container.mmd)
