# Open Banking - Sidecar Pattern Container View [Azure / Python / FastAPI]
...
## Diagrama
[Open Banking - Sidecar Pattern Container View (Azure / Python / FastAPI)](./open-banking-sidecar-python-fastapi-container.mmd)
