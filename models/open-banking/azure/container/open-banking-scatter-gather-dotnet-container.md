# Open Banking - Scatter-Gather Container View [Azure / .NET 8 / ASP.NET Core]
...
## Descrição
Distribui requisicao para multiplos destinatarios e agrega respostas na camada de containers de open finance brasil
...
## Diagrama
[Open Banking - Scatter-Gather Container View (Azure / .NET 8 / ASP.NET Core)](./open-banking-scatter-gather-dotnet-container.mmd)
