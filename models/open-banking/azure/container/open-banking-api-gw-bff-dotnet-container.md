# Open Banking - API Gateway BFF Container View [Azure / .NET 8 / ASP.NET Core]
...
## Diagrama
[Open Banking - API Gateway BFF Container View (Azure / .NET 8 / ASP.NET Core)](./open-banking-api-gw-bff-dotnet-container.mmd)
