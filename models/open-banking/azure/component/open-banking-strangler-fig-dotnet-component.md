# Open Banking - Strangler Fig - Component View [Azure / .NET 8 / ASP.NET Core]
...
## Diagrama
[Open Banking - Strangler Fig - Component View (Azure / .NET 8 / ASP.NET Core)](./open-banking-strangler-fig-dotnet-component.mmd)
