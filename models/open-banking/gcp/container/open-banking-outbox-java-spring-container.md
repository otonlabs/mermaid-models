# Open Banking - Outbox Pattern Container View [GCP / Java 21 / Spring Boot 3]
...
## Diagrama
[Open Banking - Outbox Pattern Container View (GCP / Java 21 / Spring Boot 3)](./open-banking-outbox-java-spring-container.mmd)
