# Open Banking - Request-Reply Container View [GCP / Python / FastAPI]
...
## Diagrama
[Open Banking - Request-Reply Container View (GCP / Python / FastAPI)](./open-banking-request-reply-python-fastapi-container.mmd)
