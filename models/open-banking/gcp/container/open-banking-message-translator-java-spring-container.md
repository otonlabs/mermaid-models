# Open Banking - Message Translator Container View [GCP / Java 21 / Spring Boot 3]
...
## Diagrama
[Open Banking - Message Translator Container View (GCP / Java 21 / Spring Boot 3)](./open-banking-message-translator-java-spring-container.mmd)
