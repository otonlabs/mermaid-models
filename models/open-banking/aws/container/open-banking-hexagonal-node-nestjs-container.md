# Open Banking - Hexagonal Architecture Container View [AWS / Node.js / NestJS]
...
## Diagrama
[Open Banking - Hexagonal Architecture Container View (AWS / Node.js / NestJS)](./open-banking-hexagonal-node-nestjs-container.mmd)
