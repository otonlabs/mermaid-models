# Open Banking - Sidecar Pattern Container View [AWS / Python / FastAPI]
...
## Diagrama
[Open Banking - Sidecar Pattern Container View (AWS / Python / FastAPI)](./open-banking-sidecar-python-fastapi-container.mmd)
