# Open Banking - Request-Reply Container View [AWS / Python / FastAPI]
...
## Diagrama
[Open Banking - Request-Reply Container View (AWS / Python / FastAPI)](./open-banking-request-reply-python-fastapi-container.mmd)
