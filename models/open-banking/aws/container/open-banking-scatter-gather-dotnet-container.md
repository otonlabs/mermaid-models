# Open Banking - Scatter-Gather Container View [AWS / .NET 8 / ASP.NET Core]
...
## Diagrama
[Open Banking - Scatter-Gather Container View (AWS / .NET 8 / ASP.NET Core)](./open-banking-scatter-gather-dotnet-container.mmd)
