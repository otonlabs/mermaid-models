# Open Banking - Competing Consumers Container View [Oracle Cloud / Node.js / NestJS]
...
## Descrição
Multiplos consumidores competem para processar mensagens de fila compartilhada na camada de containers de open finance brasil
...
## Diagrama
[Open Banking - Competing Consumers Container View (Oracle Cloud / Node.js / NestJS)](./open-banking-competing-consumers-node-nestjs-container.mmd)
