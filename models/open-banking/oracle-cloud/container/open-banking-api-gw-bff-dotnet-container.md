# Open Banking - API Gateway BFF Container View [Oracle Cloud / .NET 8 / ASP.NET Core]
...
## Descrição
Backend-for-Frontend com API Gateway por canal nos containers de open finance brasil
...
## Diagrama
[Open Banking - API Gateway BFF Container View (Oracle Cloud / .NET 8 / ASP.NET Core)](./open-banking-api-gw-bff-dotnet-container.mmd)
