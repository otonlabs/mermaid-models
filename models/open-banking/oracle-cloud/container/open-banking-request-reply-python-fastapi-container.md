# Open Banking - Request-Reply Container View [Oracle Cloud / Python / FastAPI]
...
## Diagrama
[Open Banking - Request-Reply Container View (Oracle Cloud / Python / FastAPI)](./open-banking-request-reply-python-fastapi-container.mmd)
