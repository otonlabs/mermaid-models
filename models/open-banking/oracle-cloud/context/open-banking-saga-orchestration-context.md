# Open Banking com Saga Orchestration [Oracle Cloud]
...
- **Open Banking Platform** — sistema principal (Coordena transacoes distribuidas via orquestrador central no contexto de open fi)
...
## Diagrama
[Open Banking com Saga Orchestration (Oracle Cloud)](./open-banking-saga-orchestration-context.mmd)
