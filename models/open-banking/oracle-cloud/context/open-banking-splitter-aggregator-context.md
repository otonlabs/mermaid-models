# Open Banking com Splitter-Aggregator [Oracle Cloud]
...
- **Open Banking Platform** — sistema principal (Divide mensagens compostas e agrega respostas aplicado ao contexto de open finan)
...
## Diagrama
[Open Banking com Splitter-Aggregator (Oracle Cloud)](./open-banking-splitter-aggregator-context.mmd)
