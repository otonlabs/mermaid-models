# Open Banking com Saga Choreography [Oracle Cloud]
...
- **Open Banking Platform** — sistema principal (Coordena transacoes distribuidas via coreografia de eventos no contexto de open )
...
## Diagrama
[Open Banking com Saga Choreography (Oracle Cloud)](./open-banking-saga-choreography-context.mmd)
