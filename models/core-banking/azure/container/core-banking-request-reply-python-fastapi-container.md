# Core Banking - Request-Reply Container View [Azure / Python / FastAPI]
...
## Diagrama
[Core Banking - Request-Reply Container View (Azure / Python / FastAPI)](./core-banking-request-reply-python-fastapi-container.mmd)
