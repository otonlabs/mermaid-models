# Core Banking - Message Translator Container View [Azure / Java 21 / Spring Boot 3]
...
## Diagrama
[Core Banking - Message Translator Container View (Azure / Java 21 / Spring Boot 3)](./core-banking-message-translator-java-spring-container.mmd)
