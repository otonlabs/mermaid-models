# Core Banking - Scatter-Gather Container View [Azure / .NET 8 / ASP.NET Core]
...
## Descrição
Distribui requisicao para multiplos destinatarios e agrega respostas na camada de containers de plataforma core banking
...
## Diagrama
[Core Banking - Scatter-Gather Container View (Azure / .NET 8 / ASP.NET Core)](./core-banking-scatter-gather-dotnet-container.mmd)
