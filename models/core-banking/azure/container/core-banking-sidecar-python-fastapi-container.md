# Core Banking - Sidecar Pattern Container View [Azure / Python / FastAPI]
...
## Diagrama
[Core Banking - Sidecar Pattern Container View (Azure / Python / FastAPI)](./core-banking-sidecar-python-fastapi-container.mmd)
