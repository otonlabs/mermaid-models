# Core Banking - Sidecar Pattern Container View [AWS / Python / FastAPI]
...
## Descrição
Deploy de componentes auxiliares ao lado do servico principal nos containers de plataforma core banking
...
## Diagrama
[Core Banking - Sidecar Pattern Container View (AWS / Python / FastAPI)](./core-banking-sidecar-python-fastapi-container.mmd)
