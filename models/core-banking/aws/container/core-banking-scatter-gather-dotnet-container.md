# Core Banking - Scatter-Gather Container View [AWS / .NET 8 / ASP.NET Core]
...
## Diagrama
[Core Banking - Scatter-Gather Container View (AWS / .NET 8 / ASP.NET Core)](./core-banking-scatter-gather-dotnet-container.mmd)
