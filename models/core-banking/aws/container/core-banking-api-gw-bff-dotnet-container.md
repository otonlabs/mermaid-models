# Core Banking - API Gateway BFF Container View [AWS / .NET 8 / ASP.NET Core]
...
## Descrição
Backend-for-Frontend com API Gateway por canal nos containers de plataforma core banking
...
## Diagrama
[Core Banking - API Gateway BFF Container View (AWS / .NET 8 / ASP.NET Core)](./core-banking-api-gw-bff-dotnet-container.mmd)
