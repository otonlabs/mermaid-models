# Core Banking - Request-Reply Container View [AWS / Python / FastAPI]
...
## Descrição
Envia requisicao e aguarda resposta correlacionada na camada de containers de plataforma core banking
...
## Diagrama
[Core Banking - Request-Reply Container View (AWS / Python / FastAPI)](./core-banking-request-reply-python-fastapi-container.mmd)
