# Core Banking - Message Translator Container View [AWS / Java 21 / Spring Boot 3]
...
## Descrição
Traduz mensagens entre formatos diferentes via modelo canonico na camada de containers de plataforma core banking

## Componentes Principais
- **Core Banking Service** — serviço principal rodando em ECS Fargate
...
## Diagrama
[Core Banking - Message Translator Container View (AWS / Java 21 / Spring Boot 3)](./core-banking-message-translator-java-spring-container.mmd)
