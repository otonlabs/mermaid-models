# Core Banking - Pipes and Filters Container View [AWS / Go / gRPC]
...
## Descrição
Processa mensagens atraves de pipeline de filtros sequenciais na camada de containers de plataforma core banking
...
## Diagrama
[Core Banking - Pipes and Filters Container View (AWS / Go / gRPC)](./core-banking-pipes-filters-go-grpc-container.mmd)
