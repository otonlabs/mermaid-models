# Core Banking - Cqrs Es - Component View [AWS / Python / FastAPI]
...
## Diagrama
[Core Banking - Cqrs Es - Component View (AWS / Python / FastAPI)](./core-banking-cqrs-es-python-fastapi-component.mmd)
