# Core Banking - Sidecar Pattern Container View [Oracle Cloud / Python / FastAPI]
...
## Diagrama
[Core Banking - Sidecar Pattern Container View (Oracle Cloud / Python / FastAPI)](./core-banking-sidecar-python-fastapi-container.mmd)
