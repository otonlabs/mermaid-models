# Core Banking - API Gateway BFF Container View [Oracle Cloud / .NET 8 / ASP.NET Core]
...
## Diagrama
[Core Banking - API Gateway BFF Container View (Oracle Cloud / .NET 8 / ASP.NET Core)](./core-banking-api-gw-bff-dotnet-container.mmd)
