# Core Banking - Request-Reply Container View [Oracle Cloud / Python / FastAPI]
...
## Diagrama
[Core Banking - Request-Reply Container View (Oracle Cloud / Python / FastAPI)](./core-banking-request-reply-python-fastapi-container.mmd)
