# Core Banking - Outbox Pattern Container View [Oracle Cloud / Java 21 / Spring Boot 3]
...
## Diagrama
[Core Banking - Outbox Pattern Container View (Oracle Cloud / Java 21 / Spring Boot 3)](./core-banking-outbox-java-spring-container.mmd)
