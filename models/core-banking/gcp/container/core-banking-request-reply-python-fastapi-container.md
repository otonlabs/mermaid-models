# Core Banking - Request-Reply Container View [GCP / Python / FastAPI]
...
## Diagrama
[Core Banking - Request-Reply Container View (GCP / Python / FastAPI)](./core-banking-request-reply-python-fastapi-container.mmd)
