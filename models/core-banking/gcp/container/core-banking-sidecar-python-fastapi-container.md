# Core Banking - Sidecar Pattern Container View [GCP / Python / FastAPI]
...
## Diagrama
[Core Banking - Sidecar Pattern Container View (GCP / Python / FastAPI)](./core-banking-sidecar-python-fastapi-container.mmd)
