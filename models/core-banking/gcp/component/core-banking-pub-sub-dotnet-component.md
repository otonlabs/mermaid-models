# Core Banking - Pub Sub - Component View [GCP / .NET 8 / ASP.NET Core]
...
## Diagrama
[Core Banking - Pub Sub - Component View (GCP / .NET 8 / ASP.NET Core)](./core-banking-pub-sub-dotnet-component.mmd)
