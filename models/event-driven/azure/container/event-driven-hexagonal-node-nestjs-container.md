# Event Driven - Hexagonal Architecture Container View [Azure / Node.js / NestJS]
...
## Diagrama
[Event Driven - Hexagonal Architecture Container View (Azure / Node.js / NestJS)](./event-driven-hexagonal-node-nestjs-container.mmd)
