# Event Driven - Request-Reply Container View [Azure / Python / FastAPI]
...
## Diagrama
[Event Driven - Request-Reply Container View (Azure / Python / FastAPI)](./event-driven-request-reply-python-fastapi-container.mmd)
