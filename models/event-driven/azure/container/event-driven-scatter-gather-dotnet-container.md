# Event Driven - Scatter-Gather Container View [Azure / .NET 8 / ASP.NET Core]
...
## Descrição
Distribui requisicao para multiplos destinatarios e agrega respostas na camada de containers de arquitetura event-driven
...
## Diagrama
[Event Driven - Scatter-Gather Container View (Azure / .NET 8 / ASP.NET Core)](./event-driven-scatter-gather-dotnet-container.mmd)
