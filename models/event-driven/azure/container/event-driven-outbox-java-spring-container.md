# Event Driven - Outbox Pattern Container View [Azure / Java 21 / Spring Boot 3]
...
## Diagrama
[Event Driven - Outbox Pattern Container View (Azure / Java 21 / Spring Boot 3)](./event-driven-outbox-java-spring-container.mmd)
