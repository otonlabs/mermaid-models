# Event Driven - API Gateway BFF Container View [Azure / .NET 8 / ASP.NET Core]
...
## Diagrama
[Event Driven - API Gateway BFF Container View (Azure / .NET 8 / ASP.NET Core)](./event-driven-api-gw-bff-dotnet-container.mmd)
