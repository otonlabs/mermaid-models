# Event Driven - Sidecar Pattern Container View [Azure / Python / FastAPI]
...
## Diagrama
[Event Driven - Sidecar Pattern Container View (Azure / Python / FastAPI)](./event-driven-sidecar-python-fastapi-container.mmd)
