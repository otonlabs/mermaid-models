# Event Driven - Sidecar Pattern Container View [AWS / Python / FastAPI]
...
## Diagrama
[Event Driven - Sidecar Pattern Container View (AWS / Python / FastAPI)](./event-driven-sidecar-python-fastapi-container.mmd)
