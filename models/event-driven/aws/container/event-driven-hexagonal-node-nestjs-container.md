# Event Driven - Hexagonal Architecture Container View [AWS / Node.js / NestJS]
...
## Diagrama
[Event Driven - Hexagonal Architecture Container View (AWS / Node.js / NestJS)](./event-driven-hexagonal-node-nestjs-container.mmd)
