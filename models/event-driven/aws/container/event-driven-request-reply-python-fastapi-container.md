# Event Driven - Request-Reply Container View [AWS / Python / FastAPI]
...
## Diagrama
[Event Driven - Request-Reply Container View (AWS / Python / FastAPI)](./event-driven-request-reply-python-fastapi-container.mmd)
