# Event Driven - Sidecar Pattern Container View [GCP / Python / FastAPI]
...
## Diagrama
[Event Driven - Sidecar Pattern Container View (GCP / Python / FastAPI)](./event-driven-sidecar-python-fastapi-container.mmd)
