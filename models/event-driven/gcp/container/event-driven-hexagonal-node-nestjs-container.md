# Event Driven - Hexagonal Architecture Container View [GCP / Node.js / NestJS]
...
## Diagrama
[Event Driven - Hexagonal Architecture Container View (GCP / Node.js / NestJS)](./event-driven-hexagonal-node-nestjs-container.mmd)
