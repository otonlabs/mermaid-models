# Event Driven - Scatter-Gather Container View [GCP / .NET 8 / ASP.NET Core]
...
## Diagrama
[Event Driven - Scatter-Gather Container View (GCP / .NET 8 / ASP.NET Core)](./event-driven-scatter-gather-dotnet-container.mmd)
