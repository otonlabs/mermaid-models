# Event Driven - Message Translator Container View [GCP / Java 21 / Spring Boot 3]
...
## Diagrama
[Event Driven - Message Translator Container View (GCP / Java 21 / Spring Boot 3)](./event-driven-message-translator-java-spring-container.mmd)
