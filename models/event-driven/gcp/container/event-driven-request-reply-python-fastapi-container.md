# Event Driven - Request-Reply Container View [GCP / Python / FastAPI]
...
## Diagrama
[Event Driven - Request-Reply Container View (GCP / Python / FastAPI)](./event-driven-request-reply-python-fastapi-container.mmd)
