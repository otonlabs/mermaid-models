# Event Driven - Bulkhead Pattern Container View [Oracle Cloud / Go / gRPC]
...
## Descrição
Isola recursos criticos para prevenir falhas em cascata nos containers de arquitetura event-driven
...
## Diagrama
[Event Driven - Bulkhead Pattern Container View (Oracle Cloud / Go / gRPC)](./event-driven-bulkhead-go-grpc-container.mmd)
