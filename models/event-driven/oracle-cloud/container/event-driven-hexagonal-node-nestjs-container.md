# Event Driven - Hexagonal Architecture Container View [Oracle Cloud / Node.js / NestJS]
...
## Descrição
Ports and Adapters para isolamento de dominio nos containers de arquitetura event-driven
...
## Diagrama
[Event Driven - Hexagonal Architecture Container View (Oracle Cloud / Node.js / NestJS)](./event-driven-hexagonal-node-nestjs-container.mmd)
