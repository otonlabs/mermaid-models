# Event Driven - Pipes and Filters Container View [Oracle Cloud / Go / gRPC]
...
## Descrição
Processa mensagens atraves de pipeline de filtros sequenciais na camada de containers de arquitetura event-driven
...
## Diagrama
[Event Driven - Pipes and Filters Container View (Oracle Cloud / Go / gRPC)](./event-driven-pipes-filters-go-grpc-container.mmd)
