# Event Driven - Request-Reply Container View [Oracle Cloud / Python / FastAPI]
...
## Descrição
Envia requisicao e aguarda resposta correlacionada na camada de containers de arquitetura event-driven
...
## Diagrama
[Event Driven - Request-Reply Container View (Oracle Cloud / Python / FastAPI)](./event-driven-request-reply-python-fastapi-container.mmd)
