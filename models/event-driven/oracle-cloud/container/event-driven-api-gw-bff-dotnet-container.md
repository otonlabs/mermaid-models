# Event Driven - API Gateway BFF Container View [Oracle Cloud / .NET 8 / ASP.NET Core]
...
## Diagrama
[Event Driven - API Gateway BFF Container View (Oracle Cloud / .NET 8 / ASP.NET Core)](./event-driven-api-gw-bff-dotnet-container.mmd)
