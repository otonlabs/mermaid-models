# Event Driven - Strangler Fig - Component View [Oracle Cloud / .NET 8 / ASP.NET Core]
...
## Diagrama
[Event Driven - Strangler Fig - Component View (Oracle Cloud / .NET 8 / ASP.NET Core)](./event-driven-strangler-fig-dotnet-component.mmd)
