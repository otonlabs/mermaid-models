# Anti-Fraud - Outbox Pattern Container View [AWS / Java 21 / Spring Boot 3]
...
## Diagrama
[Anti-Fraud - Outbox Pattern Container View (AWS / Java 21 / Spring Boot 3)](./anti-fraud-outbox-java-spring-container.mmd)
