# Anti-Fraud - Request-Reply Container View [Azure / Python / FastAPI]
...
## Diagrama
[Anti-Fraud - Request-Reply Container View (Azure / Python / FastAPI)](./anti-fraud-request-reply-python-fastapi-container.mmd)
