# Anti-Fraud - Sidecar Pattern Container View [Oracle Cloud / Python / FastAPI]
...
## Descrição
Deploy de componentes auxiliares ao lado do servico principal nos containers de motor anti-fraude e risco
...
## Diagrama
[Anti-Fraud - Sidecar Pattern Container View (Oracle Cloud / Python / FastAPI)](./anti-fraud-sidecar-python-fastapi-container.mmd)
