# Anti-Fraud - Bulkhead Pattern Container View [Oracle Cloud / Go / gRPC]
...
## Descrição
Isola recursos criticos para prevenir falhas em cascata nos containers de motor anti-fraude e risco
...
## Diagrama
[Anti-Fraud - Bulkhead Pattern Container View (Oracle Cloud / Go / gRPC)](./anti-fraud-bulkhead-go-grpc-container.mmd)
