# Anti-Fraud - Hexagonal Architecture Container View [Oracle Cloud / Node.js / NestJS]
...
## Descrição
Ports and Adapters para isolamento de dominio nos containers de motor anti-fraude e risco
...
## Diagrama
[Anti-Fraud - Hexagonal Architecture Container View (Oracle Cloud / Node.js / NestJS)](./anti-fraud-hexagonal-node-nestjs-container.mmd)
