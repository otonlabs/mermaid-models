# Anti-Fraud - API Gateway BFF Container View [Oracle Cloud / .NET 8 / ASP.NET Core]
...
## Descrição
Backend-for-Frontend com API Gateway por canal nos containers de motor anti-fraude e risco
...
## Diagrama
[Anti-Fraud - API Gateway BFF Container View (Oracle Cloud / .NET 8 / ASP.NET Core)](./anti-fraud-api-gw-bff-dotnet-container.mmd)
