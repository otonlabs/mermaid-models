# Anti-Fraud - Message Translator Container View [Oracle Cloud / Java 21 / Spring Boot 3]
...
## Descrição
Traduz mensagens entre formatos diferentes via modelo canonico na camada de containers de motor anti-fraude e risco
...
## Diagrama
[Anti-Fraud - Message Translator Container View (Oracle Cloud / Java 21 / Spring Boot 3)](./anti-fraud-message-translator-java-spring-container.mmd)
