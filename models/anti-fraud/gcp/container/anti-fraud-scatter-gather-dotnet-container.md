# Anti-Fraud - Scatter-Gather Container View [GCP / .NET 8 / ASP.NET Core]
...
## Diagrama
[Anti-Fraud - Scatter-Gather Container View (GCP / .NET 8 / ASP.NET Core)](./anti-fraud-scatter-gather-dotnet-container.mmd)
