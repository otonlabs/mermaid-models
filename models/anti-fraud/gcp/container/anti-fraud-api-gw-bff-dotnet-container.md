# Anti-Fraud - API Gateway BFF Container View [GCP / .NET 8 / ASP.NET Core]
...
## Diagrama
[Anti-Fraud - API Gateway BFF Container View (GCP / .NET 8 / ASP.NET Core)](./anti-fraud-api-gw-bff-dotnet-container.mmd)
