# DDA - Outbox Pattern Container View [AWS / Java 21 / Spring Boot 3]
...
## Diagrama
[DDA - Outbox Pattern Container View (AWS / Java 21 / Spring Boot 3)](./dda-outbox-java-spring-container.mmd)
