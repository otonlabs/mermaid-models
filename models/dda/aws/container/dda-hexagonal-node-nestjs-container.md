# DDA - Hexagonal Architecture Container View [AWS / Node.js / NestJS]
...
## Descrição
Ports and Adapters para isolamento de dominio nos containers de debito direto autorizado
...
## Diagrama
[DDA - Hexagonal Architecture Container View (AWS / Node.js / NestJS)](./dda-hexagonal-node-nestjs-container.mmd)
