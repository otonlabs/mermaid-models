# DDA - Message Translator Container View [AWS / Java 21 / Spring Boot 3]
...
- **DDA Service** — serviço principal rodando em ECS Fargate
...
## Diagrama
[DDA - Message Translator Container View (AWS / Java 21 / Spring Boot 3)](./dda-message-translator-java-spring-container.mmd)
