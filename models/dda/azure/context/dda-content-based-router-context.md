# DDA com Content-Based Router [Azure]
...
- **DDA Platform** — sistema principal (Roteia mensagens para canais diferentes baseado no conteudo aplicado ao contexto)
...
## Diagrama
[DDA com Content-Based Router (Azure)](./dda-content-based-router-context.mmd)
