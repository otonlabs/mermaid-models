# DDA - Message Translator Container View [Azure / Java 21 / Spring Boot 3]
...
## Diagrama
[DDA - Message Translator Container View (Azure / Java 21 / Spring Boot 3)](./dda-message-translator-java-spring-container.mmd)
