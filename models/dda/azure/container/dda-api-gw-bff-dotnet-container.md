# DDA - API Gateway BFF Container View [Azure / .NET 8 / ASP.NET Core]
...
## Diagrama
[DDA - API Gateway BFF Container View (Azure / .NET 8 / ASP.NET Core)](./dda-api-gw-bff-dotnet-container.mmd)
