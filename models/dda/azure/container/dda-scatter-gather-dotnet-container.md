# DDA - Scatter-Gather Container View [Azure / .NET 8 / ASP.NET Core]
...
## Descrição
Distribui requisicao para multiplos destinatarios e agrega respostas na camada de containers de debito direto autorizado
...
## Diagrama
[DDA - Scatter-Gather Container View (Azure / .NET 8 / ASP.NET Core)](./dda-scatter-gather-dotnet-container.mmd)
