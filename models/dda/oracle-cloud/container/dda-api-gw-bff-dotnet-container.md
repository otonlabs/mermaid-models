# DDA - API Gateway BFF Container View [Oracle Cloud / .NET 8 / ASP.NET Core]
...
## Descrição
Backend-for-Frontend com API Gateway por canal nos containers de debito direto autorizado
...
## Diagrama
[DDA - API Gateway BFF Container View (Oracle Cloud / .NET 8 / ASP.NET Core)](./dda-api-gw-bff-dotnet-container.mmd)
