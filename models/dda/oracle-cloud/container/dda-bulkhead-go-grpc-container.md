# DDA - Bulkhead Pattern Container View [Oracle Cloud / Go / gRPC]
...
## Descrição
Isola recursos criticos para prevenir falhas em cascata nos containers de debito direto autorizado
...
## Diagrama
[DDA - Bulkhead Pattern Container View (Oracle Cloud / Go / gRPC)](./dda-bulkhead-go-grpc-container.mmd)
