# DDA - Message Translator Container View [Oracle Cloud / Java 21 / Spring Boot 3]
...
## Descrição
Traduz mensagens entre formatos diferentes via modelo canonico na camada de containers de debito direto autorizado

## Componentes Principais
- **DDA Service** — serviço principal rodando em OKE
...
## Diagrama
[DDA - Message Translator Container View (Oracle Cloud / Java 21 / Spring Boot 3)](./dda-message-translator-java-spring-container.mmd)
