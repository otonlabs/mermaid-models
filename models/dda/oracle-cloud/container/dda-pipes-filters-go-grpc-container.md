# DDA - Pipes and Filters Container View [Oracle Cloud / Go / gRPC]
...
## Descrição
Processa mensagens atraves de pipeline de filtros sequenciais na camada de containers de debito direto autorizado
...
## Diagrama
[DDA - Pipes and Filters Container View (Oracle Cloud / Go / gRPC)](./dda-pipes-filters-go-grpc-container.mmd)
