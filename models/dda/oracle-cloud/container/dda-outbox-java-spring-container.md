# DDA - Outbox Pattern Container View [Oracle Cloud / Java 21 / Spring Boot 3]
...
## Descrição
Garante publicacao confiavel de mensagens via transactional outbox nos containers de debito direto autorizado
...
## Diagrama
[DDA - Outbox Pattern Container View (Oracle Cloud / Java 21 / Spring Boot 3)](./dda-outbox-java-spring-container.mmd)
