# DDA - Request-Reply Container View [Oracle Cloud / Python / FastAPI]
...
## Descrição
Envia requisicao e aguarda resposta correlacionada na camada de containers de debito direto autorizado
...
## Diagrama
[DDA - Request-Reply Container View (Oracle Cloud / Python / FastAPI)](./dda-request-reply-python-fastapi-container.mmd)
